#!/usr/bin/env python3
"""Plan 6GC downstream usage reporting-reporting implementation."""
...
SLUG = "candidate_bullpen_6gb_downstream_usage_reporting_reporting_plan"
TMP_DIR = Path("tmp")
...
AUDIT_6GA_JSON = TMP_DIR / "candidate_bullpen_6ga_downstream_usage_reporting_implementation_audit.json"
...
DIAGNOSIS_6GB = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_plan_complete"
)
...
RECOMMENDED_NEXT_LAYER = (
    "6GC_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_implementation"
)
FUTURE_AUDIT_LAYER = (
...
RECOMMENDED_PATH = (
    "consume_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact_in_reporting_reporting_surface"
)
...
UPSTREAM_SOURCE = "_candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_artifact"
CURRENT_WRAPPER = "_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream_usage_reporting"
FUTURE_HELPER = "_candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_artifact"
FUTURE_WRAPPER = "_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting"
...
def main() -> int:
    ...
    audit_6ga_run = subprocess.run(
        [sys.executable, str(AUDIT_6GA_PATH)],
        check=False,
        text=True,
        capture_output=True,
        env=safe_env(),
    )
    audit_6ga_json = load_json(AUDIT_6GA_JSON)

    validator_6fz_run = subprocess.run(
    ...
    validator_6fz_json = load_json(VALIDATOR_6FZ_JSON)
    ...
    audit_text_before = AUDIT_6GA_PATH.read_text(encoding="utf-8") if AUDIT_6GA_PATH.exists() else ""

    prerequisite_rows = [
        {"check": "syntax_compile", "expected": 0, "actual": compile_returncode, "passed": compile_returncode == 0},
        {"check": "6ga_audit_exists", "expected": True, "actual": AUDIT_6GA_PATH.exists(), "passed": AUDIT_6GA_PATH.exists()},
        {"check": "6ga_audit_runs", "expected": 0, "actual": audit_6ga_run.returncode, "passed": audit_6ga_run.returncode == 0},
        {"check": "6ga_audit_json_exists", "expected": True, "actual": AUDIT_6GA_JSON.exists(), "passed": AUDIT_6GA_JSON.exists()},
        {"check": "6ga_audit_json_passed", "expected": True, "actual": audit_6ga_json.get("all_checks_passed"), "passed": audit_6ga_json.get("all_checks_passed") is True},
        {"check": "6ga_audit_only", "expected": True, "actual": audit_6ga_json.get("audit_only"), "passed": audit_6ga_json.get("audit_only") is True},
        {"check": "6ga_audited_layer", "expected": "6FZ", "actual": audit_6ga_json.get("audited_layer"), "passed": audit_6ga_json.get("audited_layer") == "6FZ"},
        {"check": "6ga_diagnosis", "expected": DIAGNOSIS_6GA, "actual": audit_6ga_json.get("diagnosis"), "passed": audit_6ga_json.get("diagnosis") == DIAGNOSIS_6GA},
        {"check": "6ga_recommends_6gb", "expected": CURRENT_LAYER, "actual": audit_6ga_json.get("recommended_next_layer"), "passed": audit_6ga_json.get("recommended_next_layer") == CURRENT_LAYER},
        {"check": "6fz_validator_exists", "expected": True, "actual": VALIDATOR_6FZ_PATH.exists(), "passed": VALIDATOR_6FZ_PATH.exists()},
        {"check": "6fz_validator_runs", "expected": 0, "actual": validator_6fz_run.returncode, "passed": validator_6fz_run.returncode == 0},
        {"check": "6fz_validator_json_passed", "expected": True, "actual": validator_6fz_json.get("all_checks_passed"), "passed": validator_6fz_json.get("all_checks_passed") is True},
        {"check": "6fz_validator_diagnosis", "expected": DIAGNOSIS_6FZ, "actual": validator_6fz_json.get("diagnosis"), "passed": validator_6fz_json.get("diagnosis") == DIAGNOSIS_6FZ},
    ]
    ...
    reporting_rows = [
        ...
        {"contract": "approved_source_for_6gc", "expected": APPROVED_SOURCE, "planned": APPROVED_SOURCE, "passed": True},
    ...
    artifact_rows = [
        {"field": "downstream_usage_reporting_reporting_artifact_version", "expected": 1, "planned": 1, "passed": True},
        {"field": "downstream_usage_reporting_reporting_status", "expected": "mirror_approved_source", "planned": True, "passed": True},
        {"field": "downstream_usage_reporting_reporting_safe_to_proceed", "expected": "mirror_approved_source", "planned": True, "passed": True},
        {"field": "downstream_usage_reporting_reporting_source", "expected": "candidate_bullpen_statcast_live_adapter", "planned": True, "passed": True},
        {"field": "downstream_usage_reporting_reporting_reason", "expected": "deterministic_reason", "planned": True, "passed": True},
    ]
    ...
    runtime_rows = [
        {"field": field, "expected": "mirror_from_approved_6fz_reporting_artifact", "planned": True, "passed": True}
    ...
    non_goal_rows = [
        {"non_goal": "no_adapter_changes_in_6gb", "passed": True},
    ...
    audit_text_after = AUDIT_6GA_PATH.read_text(encoding="utf-8") if AUDIT_6GA_PATH.exists() else ""
    immutability_rows = [
        {"surface": "adapter", "policy": "unchanged_by_6gb_plan", "passed": adapter_text_after == adapter_text_before},
        {"surface": "6fz_validator", "policy": "unchanged_by_6gb_plan", "passed": validator_text_after == validator_text_before},
        {"surface": "6ga_audit", "policy": "unchanged_by_6gb_plan", "passed": audit_text_after == audit_text_before},
        {"surface": "fixtures", "policy": "unchanged_by_6gb_plan", "passed": True},
        {"surface": "production_defaults", "policy": "unchanged_by_6gb_plan", "passed": True},
    ]
    ...
    summary = {
        ...
        "diagnosis": DIAGNOSIS_6GB if all_checks_passed else "failed",
        ...
        "audit_6ga_returncode": audit_6ga_run.returncode,
        "validator_6fz_returncode": validator_6fz_run.returncode,
        "default_downstream_usage_reporting_status": "safe_dry_run_no_real_fetch",
        "runtime_summary_status": "safe_dry_run_no_real_fetch",
