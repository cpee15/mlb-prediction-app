...
OUTPUT_DIR = ROOT / "tmp" / "layer_9CI_validation_result_evidence_plan"

PREDECESSOR_PATH = (
    ROOT / "scripts" / "validate_9CH_validation_result_evidence.py"
)
...
RESULT_EVIDENCE_PRINCIPLES = [
    {
        ...
        "principle": (
            "Replay Layer 9CH validation records deterministically before "
...
RESULT_EVIDENCE_REQUIREMENTS = [
    ...
    {"requirement_id": "HOASEHOFMRVEPVREVREVREVREVRE-R05", "requirement": "predecessor_validation_digest_preserved", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVREVREVRE-R06", "requirement": "source_result_evidence_digest_preserved", "expected": True},
...
RESULT_EVIDENCE_PLAN_RECORD_FIELDS = [
    ...
    "validation_result_evidence_validation_source_record_identity_digest",
    "validation_result_evidence_validation_source_record_digest",
...
def replay_predecessor() -> dict[str, Any]:
    ...
    if (
        ...
        raise RuntimeError(
            "Unexpected Layer 9CH contract version: "
    ...
    if plan.VALIDATION_PLAN_VERSION != EXPECTED_PLAN_VERSION:
        raise RuntimeError(
            "Unexpected Layer 9CG plan version: "
...
def main() -> int:
    ...
    checks = [
        ...
        {
            "check": "nine_cg_plan_digest_preserved",
        ...
        {
            "check": "validation_digest_preserved",
        ...
        {
            "check": "reverse_validation_digest_preserved",
        ...
        },
        {
            ...
            "actual": sum(
                bool(row["validation_result_evidence_validation_rationale"])
                and bool(row["validation_result_evidence_validation_limitations"])
                and bool(
                    row[
                        "validation_result_evidence_validation_"
                        "authority_boundary"
    ...
    next_layer = (
        "9CJ_validation_result_evidence_validation_result_evidence_implementation"
        if all_checks_passed
        else "9CI_validation_result_evidence_validation_result_evidence_plan_remediation"
    )
    ...
    summary = {
        ...
        "layer_9CG_plan_digest": replay["plan_digest"],
        "layer_9CF_result_evidence_digest":
            replay["source_result_digest"],
    ...
    print(f"Layer 9CG plan digest: {replay['plan_digest']}")
    print(
        "Layer 9CF result-evidence digest: "
