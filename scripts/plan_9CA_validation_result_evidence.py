...
Defines the deterministic evidence plan for Layer 9BZ validation results.

Planning only. This layer preserves structural validation state, lineage,
status, blockers, rationale, limitations, and authority boundaries. It does
not validate authoritative historical-outcome truth or execute retrieval,
...
OUTPUT_DIR = ROOT / "tmp" / "layer_9CA_validation_result_evidence_plan"

PREDECESSOR_PATH = (
    ROOT
    / "scripts"
    / "validate_9BZ_pitch_type_matchup_overlay_historical_outcome_"
...
RESULT_EVIDENCE_PRINCIPLES = [
    {
        "principle_id": "HOASEHOFMRVEPVREVREVRE-P01",
        "principle": (
            "Replay every Layer 9BZ validation record deterministically "
            "before defining result-evidence records."
        ),
    },
    {
        "principle_id": "HOASEHOFMRVEPVREVREVRE-P02",
        "principle": (
            "Preserve validation identity, record digest, status, blockers, "
            "rationale, limitations, and authority boundary."
        ),
    },
    {
        "principle_id": "HOASEHOFMRVEPVREVREVRE-P03",
        "principle": (
            "Preserve complete predecessor lineage through evidence, package, "
            "mapping, comparison, metric, and defect records."
        ),
    },
    {
        "principle_id": "HOASEHOFMRVEPVREVREVRE-P04",
        "principle": (
            "Structural validation success must remain separate from "
            "authoritative historical-outcome truth."
        ),
    },
    {
        "principle_id": "HOASEHOFMRVEPVREVREVRE-P05",
        "principle": (
    ...
    {
        "principle_id": "HOASEHOFMRVEPVREVREVRE-P06",
        "principle": (
            "The canonical target remains outcome_value and "
            "outcome_available_at_utc remains rejected as a substitute."
        ),
    },
    {
        "principle_id": "HOASEHOFMRVEPVREVREVRE-P07",
        "principle": (
            "Planning must not execute network, mapping, extraction, mutation, "
            "recomputation, quality, production, market, pricing, or betting work."
        ),
    },
    {
        "principle_id": "HOASEHOFMRVEPVREVREVRE-P08",
        "principle": (
            "Successful planning grants only Layer 9CB result-evidence "
...
RESULT_EVIDENCE_COMPONENTS = [
    {
        "component_id": "HOASEHOFMRVEPVREVREVRE-C01",
        "component": "validation_identity_manifest",
        "required": True,
        "priority": 1,
    },
    {
        "component_id": "HOASEHOFMRVEPVREVREVRE-C02",
        "component": "validation_digest_manifest",
        "required": True,
        "priority": 2,
    },
    {
        "component_id": "HOASEHOFMRVEPVREVREVRE-C03",
        "component": "predecessor_lineage_manifest",
        "required": True,
        "priority": 3,
    },
    {
        "component_id": "HOASEHOFMRVEPVREVREVRE-C04",
        "component": "structural_disposition_manifest",
        "required": True,
        "priority": 4,
    },
    {
        "component_id": "HOASEHOFMRVEPVREVREVRE-C05",
        "component": "candidate_evidence_absence_manifest",
        "required": True,
        "priority": 5,
    },
    {
        "component_id": "HOASEHOFMRVEPVREVREVRE-C06",
        "component": "canonical_field_identity_manifest",
        "required": True,
        "priority": 6,
    },
    {
        "component_id": "HOASEHOFMRVEPVREVREVRE-C07",
        "component": "documentation_and_blocker_manifest",
        "required": True,
        "priority": 7,
    },
    {
        "component_id": "HOASEHOFMRVEPVREVREVRE-C08",
...
RESULT_EVIDENCE_STAGES = [
    {"stage_id": "HOASEHOFMRVEPVREVREVRE-S01", "stage_name": "validation_record_replay", "priority": 1},
    {"stage_id": "HOASEHOFMRVEPVREVREVRE-S02", "stage_name": "identity_inventory", "priority": 2},
    {"stage_id": "HOASEHOFMRVEPVREVREVRE-S03", "stage_name": "digest_inventory", "priority": 3},
    {"stage_id": "HOASEHOFMRVEPVREVREVRE-S04", "stage_name": "lineage_inventory", "priority": 4},
    {"stage_id": "HOASEHOFMRVEPVREVREVRE-S05", "stage_name": "structural_disposition_inventory", "priority": 5},
    {"stage_id": "HOASEHOFMRVEPVREVREVRE-S06", "stage_name": "candidate_absence_inventory", "priority": 6},
    {"stage_id": "HOASEHOFMRVEPVREVREVRE-S07", "stage_name": "canonical_field_inventory", "priority": 7},
    {"stage_id": "HOASEHOFMRVEPVREVREVRE-S08", "stage_name": "documentation_inventory", "priority": 8},
    {"stage_id": "HOASEHOFMRVEPVREVREVRE-S09", "stage_name": "authority_boundary_inventory", "priority": 9},
    {"stage_id": "HOASEHOFMRVEPVREVREVRE-S10", "stage_name": "record_contract_definition", "priority": 10},
    {"stage_id": "HOASEHOFMRVEPVREVREVRE-S11", "stage_name": "deterministic_plan_emission", "priority": 11},
]


RESULT_EVIDENCE_REQUIREMENTS = [
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R01", "requirement": "validation_record_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R02", "requirement": "validation_record_id_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R03", "requirement": "validation_identity_digest_valid", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R04", "requirement": "validation_record_digest_valid", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R05", "requirement": "result_evidence_lineage_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R06", "requirement": "source_result_evidence_lineage_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R07", "requirement": "package_validation_lineage_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R08", "requirement": "package_record_lineage_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R09", "requirement": "mapping_validation_lineage_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R10", "requirement": "field_mapping_lineage_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R11", "requirement": "comparison_lineage_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R12", "requirement": "metric_lineage_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R13", "requirement": "defect_lineage_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R14", "requirement": "structural_validation_complete", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R15", "requirement": "authoritative_outcome_validated", "expected": False},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R16", "requirement": "candidate_derived_artifact_count_zero", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R17", "requirement": "validation_artifact_count_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R18", "requirement": "evidence_absence_explicit", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R19", "requirement": "fabricated_evidence_absent", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R20", "requirement": "canonical_field_identity_preserved", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R21", "requirement": "candidate_not_supplied_status_preserved", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R22", "requirement": "missing_endpoint_blocker_preserved", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R23", "requirement": "validation_rationale_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R24", "requirement": "validation_limitations_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R25", "requirement": "validation_authority_boundary_present", "expected": True},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R26", "requirement": "result_evidence_records_materialized_during_planning", "expected": False},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R27", "requirement": "network_retrieval_executed", "expected": False},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R28", "requirement": "mapping_or_extraction_executed", "expected": False},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R29", "requirement": "canonical_mutation_or_recomputation_executed", "expected": False},
    {"requirement_id": "HOASEHOFMRVEPVREVREVRE-R30", "requirement": "production_market_or_betting_authority_granted", "expected": False},
]
...
RESULT_EVIDENCE_STATUSES = [
    ...
    {"status": "validation_identity_invalid", "implementation_authority": False},
...
BLOCKER_CODES = [
    ...
    {"code": "validation_record_missing", "category": "record"},
    {"code": "validation_record_id_missing", "category": "identity"},
    {"code": "validation_identity_digest_missing", "category": "identity"},
    {"code": "validation_identity_digest_invalid", "category": "identity"},
    {"code": "validation_record_digest_missing", "category": "integrity"},
    {"code": "validation_record_digest_invalid", "category": "integrity"},
...
ORDERING_FIELDS = [
    ...
    {"ordinal": 6, "field": "validation_result_evidence_validation_result_evidence_record_id"},
]


IMPLEMENTATION_STEPS = [
    {"ordinal": 1, "step": "replay_layer_9BZ_validation_records"},
    ...
    {"ordinal": 12, "step": "define_result_evidence_identity_and_digest"},
    ...
    {"ordinal": 16, "step": "grant_layer_9CB_implementation_only_when_complete"},
]
...
PROHIBITED_AUTHORITIES = [
    ...
    "validation_result_evidence_validation_result_evidence_execution",
...
def replay_predecessor() -> dict[str, Any]:
    ...
    if (
        ...
        raise RuntimeError(
            "Unexpected Layer 9BZ contract version: "
...
def main() -> int:
    ...
    checks = [
        ...
        },
        {
            ...
            "expected": 53,
            "passed":
                len(RESULT_EVIDENCE_PLAN_RECORD_FIELDS) == 53,
        },
        {
    ...
    next_layer = (
        "9CB_pitch_type_matchup_overlay_historical_outcome_authoritative_source_"
        "endpoint_candidate_source_evidence_historical_outcome_field_mapping_"
        "result_validation_evidence_package_validation_result_evidence_"
        "validation_result_evidence_validation_result_evidence_implementation"
        if all_checks_passed
        else
        "9CA_validation_result_evidence_plan_remediation"
    )
    ...
    diagnosis_name = (
        ...
        "endpoint_candidate_source_evidence_historical_outcome_field_mapping_"
        "result_validation_evidence_package_validation_result_evidence_"
        "validation_result_evidence_validation_result_evidence_plan_failed"
    )
