#!/usr/bin/env python3
"""Plan 6GF downstream usage reporting-reporting-reporting implementation."""
...
SLUG = "candidate_bullpen_6ge_downstream_usage_reporting_reporting_reporting_plan"
TMP_DIR = Path("tmp")
...
AUDIT_6GD_JSON = TMP_DIR / "candidate_bullpen_6gd_downstream_usage_reporting_reporting_impl_audit.json"
...
RECOMMENDED_NEXT_LAYER = (
    "6GF_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_implementation"
)
FUTURE_AUDIT_LAYER = (
...
RECOMMENDED_PATH = (
    "consume_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_artifact_in_reporting_reporting_reporting_surface"
)
...
UPSTREAM_SOURCE = "_candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact"
CURRENT_WRAPPER = "_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting"
FUTURE_HELPER = "_candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_artifact"
FUTURE_WRAPPER = "_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting"
...
def main() -> int:
    ...
    audit_6gd_run = subprocess.run(
        [sys.executable, str(AUDIT_6GD_PATH)],
        check=False,
        text=True,
        capture_output=True,
        env=safe_env(),
    )
    audit_6gd_json = load_json(AUDIT_6GD_JSON)

    validator_6gc_run = subprocess.run(
    ...
    validator_6gc_json = load_json(VALIDATOR_6GC_JSON)
    ...
    plan_6gb_text_before = PLAN_6GB_PATH.read_text(encoding="utf-8") if PLAN_6GB_PATH.exists() else ""

    prerequisite_rows = [
        {"check": "syntax_compile", "expected": 0, "actual": compile_returncode, "passed": compile_returncode == 0},
        {"check": "6gd_audit_exists", "expected": True, "actual": AUDIT_6GD_PATH.exists(), "passed": AUDIT_6GD_PATH.exists()},
        {"check": "6gd_audit_runs", "expected": 0, "actual": audit_6gd_run.returncode, "passed": audit_6gd_run.returncode == 0},
        {"check": "6gd_audit_json_exists", "expected": True, "actual": AUDIT_6GD_JSON.exists(), "passed": AUDIT_6GD_JSON.exists()},
        {"check": "6gd_audit_json_passed", "expected": True, "actual": audit_6gd_json.get("all_checks_passed"), "passed": audit_6gd_json.get("all_checks_passed") is True},
        {"check": "6gd_audit_only", "expected": True, "actual": audit_6gd_json.get("audit_only"), "passed": audit_6gd_json.get("audit_only") is True},
        {"check": "6gd_audited_layer", "expected": "6GC", "actual": audit_6gd_json.get("audited_layer"), "passed": audit_6gd_json.get("audited_layer") == "6GC"},
        {"check": "6gd_diagnosis", "expected": DIAGNOSIS_6GD, "actual": audit_6gd_json.get("diagnosis"), "passed": audit_6gd_json.get("diagnosis") == DIAGNOSIS_6GD},
        {"check": "6gd_recommends_6ge", "expected": CURRENT_LAYER, "actual": audit_6gd_json.get("recommended_next_layer"), "passed": audit_6gd_json.get("recommended_next_layer") == CURRENT_LAYER},
        {"check": "6gc_validator_exists", "expected": True, "actual": VALIDATOR_6GC_PATH.exists(), "passed": VALIDATOR_6GC_PATH.exists()},
        {"check": "6gc_validator_runs", "expected": 0, "actual": validator_6gc_run.returncode, "passed": validator_6gc_run.returncode == 0},
        {"check": "6gc_validator_json_passed", "expected": True, "actual": validator_6gc_json.get("all_checks_passed"), "passed": validator_6gc_json.get("all_checks_passed") is True},
        {"check": "6gc_validator_diagnosis", "expected": DIAGNOSIS_6GC, "actual": validator_6gc_json.get("diagnosis"), "passed": validator_6gc_json.get("diagnosis") == DIAGNOSIS_6GC},
    ]
    ...
    reporting_rows = [
        ...
        {"contract": "approved_source_for_6gf", "expected": APPROVED_SOURCE, "planned": APPROVED_SOURCE, "passed": True},
    ...
    artifact_rows = [
        {"field": "downstream_usage_reporting_reporting_reporting_artifact_version", "expected": 1, "planned": 1, "passed": True},
        {"field": "downstream_usage_reporting_reporting_reporting_status", "expected": "mirror_approved_source", "planned": True, "passed": True},
        {"field": "downstream_usage_reporting_reporting_reporting_safe_to_proceed", "expected": "mirror_approved_source", "planned": True, "passed": True},
        {"field": "downstream_usage_reporting_reporting_reporting_source", "expected": "candidate_bullpen_statcast_live_adapter", "planned": True, "passed": True},
        {"field": "downstream_usage_reporting_reporting_reporting_reason", "expected": "deterministic_reason", "planned": True, "passed": True},
    ]
    ...
    runtime_rows = [
        {"field": field, "expected": "mirror_from_approved_6gc_reporting_reporting_artifact", "planned": True, "passed": True}
    ...
    non_goal_rows = [
        {"non_goal": "no_adapter_changes_in_6ge", "passed": True},
    ...
    plan_6gb_text_after = PLAN_6GB_PATH.read_text(encoding="utf-8") if PLAN_6GB_PATH.exists() else ""
    immutability_rows = [
        {"surface": "adapter", "policy": "unchanged_by_6ge_plan", "passed": adapter_text_after == adapter_text_before},
        {"surface": "6gd_audit", "policy": "unchanged_by_6ge_plan", "passed": audit_6gd_text_after == audit_6gd_text_before},
        {"surface": "6gc_validator", "policy": "unchanged_by_6ge_plan", "passed": validator_6gc_text_after == validator_6gc_text_before},
        {"surface": "6gb_plan", "policy": "unchanged_by_6ge_plan", "passed": plan_6gb_text_after == plan_6gb_text_before},
        {"surface": "fixtures", "policy": "unchanged_by_6ge_plan", "passed": True},
        {"surface": "production_defaults", "policy": "unchanged_by_6ge_plan", "passed": True},
    ]
    ...
    summary = {
        ...
        "diagnosis": DIAGNOSIS_6GE if all_checks_passed else "failed",
        "validated_prior_audit": "6GD",
        "validated_prior_implementation": "6GC",
        ...
        "audit_6gd_returncode": audit_6gd_run.returncode,
        "validator_6gc_returncode": validator_6gc_run.returncode,
        "default_reporting_reporting_status": "safe_dry_run_no_real_fetch",
