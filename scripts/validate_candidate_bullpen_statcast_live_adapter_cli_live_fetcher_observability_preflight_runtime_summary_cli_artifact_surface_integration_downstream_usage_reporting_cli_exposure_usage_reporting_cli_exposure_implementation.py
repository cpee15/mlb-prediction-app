#!/usr/bin/env python3
"""Validate 6FN CLI exposure surface for usage-reporting runtime-summary artifacts."""
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6fn_validator"
...
def main() -> int:
    ...
    source_rows = [
        ...
        {"check": "module_self_check_cli_exposure_wrapper_exists", "expected": True, "actual": "_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure" in target_source, "passed": "_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure" in target_source},
        {"check": "entrypoint_uses_cli_exposure_wrapper", "expected": True, "actual": "raise SystemExit(_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure())" in target_source, "passed": "raise SystemExit(_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure())" in target_source},
    ]
