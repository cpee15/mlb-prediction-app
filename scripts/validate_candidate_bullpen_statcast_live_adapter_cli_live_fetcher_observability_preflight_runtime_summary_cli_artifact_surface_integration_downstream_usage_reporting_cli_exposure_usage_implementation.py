#!/usr/bin/env python3
"""Validate 6FH downstream usage surface for CLI exposure runtime-summary artifacts."""
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6fh_validator"
...
def main() -> int:
    ...
    source_rows = [
        ...
        {"check": "module_self_check_usage_wrapper_exists", "expected": True, "actual": "_candidate_bullpen_emit_module_self_check_summary_with_cli_exposure_usage" in target_source, "passed": "_candidate_bullpen_emit_module_self_check_summary_with_cli_exposure_usage" in target_source},
        {"check": "entrypoint_uses_usage_wrapper", "expected": True, "actual": "raise SystemExit(_candidate_bullpen_emit_module_self_check_summary_with_cli_exposure_usage())" in target_source, "passed": "raise SystemExit(_candidate_bullpen_emit_module_self_check_summary_with_cli_exposure_usage())" in target_source},
    ]
