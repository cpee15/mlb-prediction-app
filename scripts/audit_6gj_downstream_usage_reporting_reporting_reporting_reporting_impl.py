#!/usr/bin/env python3
"""Audit 6GI downstream usage reporting-reporting-reporting-reporting implementation."""
...
SLUG = "candidate_bullpen_6gj_downstream_usage_reporting_reporting_reporting_reporting_impl_audit"
TMP_DIR = Path("tmp")
...
PLAN_6GH_PATH = Path("scripts/plan_6gh_downstream_usage_reporting_reporting_reporting_reporting.py")
...
VALIDATOR_6GI_JSON = TMP_DIR / "candidate_bullpen_6gi_downstream_usage_reporting_reporting_reporting_reporting_impl.json"
...
DIAGNOSIS_6GI = (
    ...
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_implementation_complete"
)
DIAGNOSIS_6GJ = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
...
RECOMMENDED_PATH = (
    "audit_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_surface"
)

HELPER = "_candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact"
WRAPPER = "_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting"
PREVIOUS_WRAPPER = "_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting"
...
def load_module() -> Any:
    spec = importlib.util.spec_from_file_location("candidate_bullpen_live_adapter_6gj", TARGET_PATH)
    if spec is None or spec.loader is None:
        raise RuntimeError(f"could not load spec for {TARGET_PATH}")
    module = importlib.util.module_from_spec(spec)
    sys.modules["candidate_bullpen_live_adapter_6gj"] = module
...
def main() -> int:
    ...
    validator_run = subprocess.run(
        [sys.executable, str(VALIDATOR_6GI_PATH)],
        check=False,
        text=True,
        capture_output=True,
        env=safe_env(),
    )
    validator_json = load_json(VALIDATOR_6GI_JSON)

    adapter_before = TARGET_PATH.read_text(encoding="utf-8") if TARGET_PATH.exists() else ""
    validator_before = VALIDATOR_6GI_PATH.read_text(encoding="utf-8") if VALIDATOR_6GI_PATH.exists() else ""
    plan_before = PLAN_6GH_PATH.read_text(encoding="utf-8") if PLAN_6GH_PATH.exists() else ""
    audit_6gg_before = AUDIT_6GG_PATH.read_text(encoding="utf-8") if AUDIT_6GG_PATH.exists() else ""
    validator_6gf_before = VALIDATOR_6GF_PATH.read_text(encoding="utf-8") if VALIDATOR_6GF_PATH.exists() else ""
    ...
    validator_rows = [
        ...
        {"check": "6gi_validator_exists", "expected": True, "actual": VALIDATOR_6GI_PATH.exists(), "passed": VALIDATOR_6GI_PATH.exists()},
        {"check": "6gi_validator_runs", "expected": 0, "actual": validator_run.returncode, "passed": validator_run.returncode == 0},
        {"check": "6gi_validator_json_exists", "expected": True, "actual": VALIDATOR_6GI_JSON.exists(), "passed": VALIDATOR_6GI_JSON.exists()},
        {"check": "6gi_validator_all_checks_passed", "expected": True, "actual": validator_json.get("all_checks_passed"), "passed": validator_json.get("all_checks_passed") is True},
        {"check": "6gi_validator_diagnosis", "expected": DIAGNOSIS_6GI, "actual": validator_json.get("diagnosis"), "passed": validator_json.get("diagnosis") == DIAGNOSIS_6GI},
        {"check": "6gi_validator_recommended_next_layer", "expected": CURRENT_LAYER, "actual": validator_json.get("recommended_next_layer"), "passed": validator_json.get("recommended_next_layer") == CURRENT_LAYER},
    ]
    ...
    reporting_rows = [
        ...
        {"check": "artifact_created", "expected": True, "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_created"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_created") is True},
        {"check": "artifact_version", "expected": 1, "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_version"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_version") == 1},
        {"check": "default_status", "expected": "safe_dry_run_no_real_fetch", "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_status"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_status") == "safe_dry_run_no_real_fetch"},
        {"check": "default_safe", "expected": True, "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_safe_to_proceed"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_safe_to_proceed") is True},
        {"check": "source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_source"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_source") == "candidate_bullpen_statcast_live_adapter"},
        {"check": "reason_present", "expected": True, "actual": bool(artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_reason")), "passed": bool(artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_reason"))},
        {"check": "status_equals_approved", "expected": approved.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_status"), "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_status"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_status") == approved.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_status")},
        {"check": "safe_equals_approved", "expected": approved.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_safe_to_proceed"), "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_safe_to_proceed"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_safe_to_proceed") == approved.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_safe_to_proceed")},
    ]
    try:
        ...
        status_rows.append(
            {
                ...
                "actual_status": scenario_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_status"),
                "passed": scenario_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_status") == expected_status,
            }
        )
        for key in [
    ...
    module_rows = [
        ...
        {"check": "reporting_reporting_reporting_reporting_created", "expected": True, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_created"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_created") is True},
        {"check": "reporting_reporting_reporting_reporting_version", "expected": 1, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_version"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_version") == 1},
        {"check": "reporting_reporting_reporting_reporting_status", "expected": "safe_dry_run_no_real_fetch", "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_status"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_status") == "safe_dry_run_no_real_fetch"},
        {"check": "reporting_reporting_reporting_reporting_safe", "expected": True, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_safe_to_proceed"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_safe_to_proceed") is True},
        {"check": "reporting_reporting_reporting_reporting_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_source"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_source") == "candidate_bullpen_statcast_live_adapter"},
    ...
    validator_after = VALIDATOR_6GI_PATH.read_text(encoding="utf-8") if VALIDATOR_6GI_PATH.exists() else ""
    plan_after = PLAN_6GH_PATH.read_text(encoding="utf-8") if PLAN_6GH_PATH.exists() else ""
    audit_6gg_after = AUDIT_6GG_PATH.read_text(encoding="utf-8") if AUDIT_6GG_PATH.exists() else ""
    validator_6gf_after = VALIDATOR_6GF_PATH.read_text(encoding="utf-8") if VALIDATOR_6GF_PATH.exists() else ""

    immutability_rows = [
        {"surface": "adapter", "policy": "unchanged_by_audit", "passed": adapter_after == adapter_before},
        {"surface": "6gi_validator", "policy": "unchanged_by_audit", "passed": validator_after == validator_before},
        {"surface": "6gh_plan", "policy": "unchanged_by_audit", "passed": plan_after == plan_before},
        {"surface": "6gg_audit", "policy": "unchanged_by_audit", "passed": audit_6gg_after == audit_6gg_before},
        {"surface": "6gf_validator", "policy": "unchanged_by_audit", "passed": validator_6gf_after == validator_6gf_before},
    ...
    recommended_rows = [
        ...
        {"check": "audited_layer", "expected": "6GI", "actual": "6GI", "passed": True},
        {"check": "audited_implementation_diagnosis", "expected": DIAGNOSIS_6GI, "actual": DIAGNOSIS_6GI, "passed": True},
        {"check": "diagnosis", "expected": DIAGNOSIS_6GJ, "actual": DIAGNOSIS_6GJ, "passed": True},
    ...
    summary = {
        ...
        "audited_implementation_diagnosis": DIAGNOSIS_6GI,
        "diagnosis": DIAGNOSIS_6GJ if all_checks_passed else "failed",
        "recommended_next_layer": RECOMMENDED_NEXT_LAYER,
        "recommended_path": RECOMMENDED_PATH,
        "validator_script": str(VALIDATOR_6GI_PATH),
        "validator_returncode": validator_run.returncode,
        "module_self_check_returncode": module_run.returncode,
        "default_reporting_reporting_reporting_reporting_status": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_status"),
