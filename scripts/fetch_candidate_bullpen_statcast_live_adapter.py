...
def _candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact(
    **downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_kwargs: Any,
) -> Dict[str, Any]:
    """Build deterministic downstream-facing output from usage-facing artifacts."""

    usage_artifact = (
        _candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact(
            **downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_kwargs
        )
    )
    cli_exposure_artifact = dict(
        usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact", {})
    )
    reporting_artifact = dict(
        usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_artifact", {})
    )
    prior_usage_artifact = dict(
        usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_artifact", {})
    )
    prior_cli_exposure_artifact = dict(
        usage_artifact.get("downstream_runtime_summary_cli_exposure_artifact", {})
    )
    ...
    cli_artifact = dict(usage_artifact.get("cli_diagnostic_artifact", {}))
    runtime_artifact = dict(usage_artifact.get("live_fetcher_runtime_summary_artifact", {}))

    artifact: Dict[str, Any] = {
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact_version": 1,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_status": usage_artifact.get(
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status"
        ),
        ...
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_reason": (
            "deterministic downstream-facing surface for downstream runtime summary CLI exposure usage reporting CLI exposure usage artifact"
        ),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact": dict(
            usage_artifact
        ),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact": cli_exposure_artifact,
        "downstream_runtime_summary_cli_exposure_usage_reporting_artifact": reporting_artifact,
        "downstream_runtime_summary_cli_exposure_usage_artifact": prior_usage_artifact,
        "downstream_runtime_summary_cli_exposure_artifact": prior_cli_exposure_artifact,
        "downstream_runtime_summary_reporting_artifact": upstream_reporting_artifact,
        "downstream_runtime_summary_usage_artifact": downstream_artifact,
        "cli_diagnostic_artifact": cli_artifact,
...
def _candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream() -> int:
    """Emit existing self-check output with downstream-facing usage fields added."""
    ...
    with contextlib.redirect_stdout(buffer):
        exit_code = (
            _candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage()
        )
    ...
    summary.update(
        {
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact_created": True,
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact_version": (
                downstream_artifact.get(
                    "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact_version"
                )
            ),
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_status": downstream_artifact.get(
            ...
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_source": downstream_artifact.get(
                "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_source"
            ),
        }
    )
...
def _candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_artifact(
    **downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_kwargs: Any,
) -> Dict[str, Any]:
    """Build deterministic downstream usage-facing output from downstream artifacts."""

    downstream_artifact = (
        _candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact(
            **downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_kwargs
        )
    )

    usage_artifact = dict(
        downstream_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact", {})
    )
    cli_exposure_artifact = dict(
        downstream_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact", {})
    )
    reporting_artifact = dict(
        downstream_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_artifact", {})
    )
    prior_usage_artifact = dict(
        downstream_artifact.get("downstream_runtime_summary_cli_exposure_usage_artifact", {})
    )
    prior_cli_exposure_artifact = dict(
        downstream_artifact.get("downstream_runtime_summary_cli_exposure_artifact", {})
    )
    upstream_reporting_artifact = dict(
        downstream_artifact.get("downstream_runtime_summary_reporting_artifact", {})
    )
    downstream_usage_artifact = dict(
        downstream_artifact.get("downstream_runtime_summary_usage_artifact", {})
    )
    cli_artifact = dict(downstream_artifact.get("cli_diagnostic_artifact", {}))
    runtime_artifact = dict(downstream_artifact.get("live_fetcher_runtime_summary_artifact", {}))

    artifact: Dict[str, Any] = {
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_artifact_version": 1,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_status": downstream_artifact.get(
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_status"
        ),
        ...
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_source": (
            "candidate_bullpen_statcast_live_adapter"
        ),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reason": (
            "deterministic downstream usage-facing surface for downstream runtime summary CLI exposure usage reporting CLI exposure usage downstream artifact"
        ),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact": dict(
            downstream_artifact
        ),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact": usage_artifact,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact": cli_exposure_artifact,
        "downstream_runtime_summary_cli_exposure_usage_reporting_artifact": reporting_artifact,
        "downstream_runtime_summary_cli_exposure_usage_artifact": prior_usage_artifact,
        "downstream_runtime_summary_cli_exposure_artifact": prior_cli_exposure_artifact,
    ...
    for field in [
        ...
        artifact[field] = downstream_artifact.get(field)
    ...
    for field in [
        ...
        if field in downstream_artifact:
            artifact[field] = downstream_artifact.get(field)

    return artifact


def _candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream_usage() -> int:
    """Emit existing downstream self-check output with downstream usage-facing fields added."""
    ...
    summary.update(
        {
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_artifact_created": True,
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_artifact_version": (
                downstream_usage_artifact.get(
                    "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_artifact_version"
                )
            ),
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_status": downstream_usage_artifact.get(
            ...
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_source": downstream_usage_artifact.get(
                "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_source"
            ),
        }
    )
...
def _candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_artifact(
    **downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_kwargs: Any,
) -> Dict[str, Any]:
    """Build deterministic downstream usage reporting-reporting output from the approved 6FZ reporting artifact."""

    downstream_usage_reporting_artifact = (
        _candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact(
            **downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_kwargs
        )
    )

    reporting_reporting_status = downstream_usage_reporting_artifact.get(
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_status",
        downstream_usage_reporting_artifact.get("live_fetcher_runtime_summary_status"),
    )
    reporting_reporting_safe_to_proceed = bool(
        downstream_usage_reporting_artifact.get(
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_safe_to_proceed",
            downstream_usage_reporting_artifact.get("live_fetcher_runtime_summary_safe_to_proceed", False),
        )
    )
    reporting_reporting_reason = downstream_usage_reporting_artifact.get(
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reason",
        downstream_usage_reporting_artifact.get("live_fetcher_runtime_summary_reason", ""),
    )

    reporting_reporting_artifact: Dict[str, Any] = {
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_artifact_created": True,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_artifact_version": 1,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_status": reporting_reporting_status,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_safe_to_proceed": reporting_reporting_safe_to_proceed,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_source": "candidate_bullpen_statcast_live_adapter",
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reason": reporting_reporting_reason,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact": downstream_usage_reporting_artifact,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_artifact": downstream_usage_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_artifact", {}),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact": downstream_usage_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact", {}),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact": downstream_usage_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact", {}),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact": downstream_usage_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact", {}),
        "downstream_runtime_summary_cli_exposure_usage_reporting_artifact": downstream_usage_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_artifact", {}),
        "downstream_runtime_summary_cli_exposure_usage_artifact": downstream_usage_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_artifact", {}),
        "downstream_runtime_summary_cli_exposure_artifact": downstream_usage_reporting_artifact.get("downstream_runtime_summary_cli_exposure_artifact", {}),
        "downstream_runtime_summary_reporting_artifact": downstream_usage_reporting_artifact.get("downstream_runtime_summary_reporting_artifact", {}),
        "downstream_runtime_summary_usage_artifact": downstream_usage_reporting_artifact.get("downstream_runtime_summary_usage_artifact", {}),
        "cli_diagnostic_artifact": downstream_usage_reporting_artifact.get("cli_diagnostic_artifact", {}),
        "live_fetcher_runtime_summary_artifact": downstream_usage_reporting_artifact.get("live_fetcher_runtime_summary_artifact", {}),
    }
    ...
    for field_name in (
        ...
        if field_name in downstream_usage_reporting_artifact:
            reporting_reporting_artifact[field_name] = downstream_usage_reporting_artifact[field_name]

    return reporting_reporting_artifact


def _candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting() -> int:
    """Emit module self-check summary with downstream usage reporting-reporting fields."""
    ...
    previous_stdout = io.StringIO()
    with contextlib.redirect_stdout(previous_stdout):
        exit_code = _candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream_usage_reporting()
    ...
    summary.update(
        {
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_artifact_created": reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_artifact_created"),
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_artifact_version": reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_artifact_version"),
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_status": reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_status"),
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_safe_to_proceed": reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_safe_to_proceed"),
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_source": reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_source"),
        }
    )
...
def _candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact(
    **downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_kwargs: Any,
) -> Dict[str, Any]:
    """Build deterministic downstream usage reporting-reporting-reporting-reporting output from the approved 6GF artifact."""

    downstream_usage_reporting_reporting_reporting_artifact = (
        _candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_artifact(
            **downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_kwargs
        )
    )

    reporting_reporting_reporting_reporting_status = downstream_usage_reporting_reporting_reporting_artifact.get(
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_status",
        downstream_usage_reporting_reporting_reporting_artifact.get("live_fetcher_runtime_summary_status"),
    )
    reporting_reporting_reporting_reporting_safe_to_proceed = bool(
        downstream_usage_reporting_reporting_reporting_artifact.get(
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_safe_to_proceed",
            downstream_usage_reporting_reporting_reporting_artifact.get("live_fetcher_runtime_summary_safe_to_proceed", False),
        )
    )
    reporting_reporting_reporting_reporting_reason = downstream_usage_reporting_reporting_reporting_artifact.get(
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reason",
        downstream_usage_reporting_reporting_reporting_artifact.get("live_fetcher_runtime_summary_reason", ""),
    )

    reporting_reporting_reporting_reporting_artifact: Dict[str, Any] = {
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_created": True,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_version": 1,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_status": reporting_reporting_reporting_reporting_status,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_safe_to_proceed": reporting_reporting_reporting_reporting_safe_to_proceed,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_source": "candidate_bullpen_statcast_live_adapter",
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_reason": reporting_reporting_reporting_reporting_reason,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_artifact": downstream_usage_reporting_reporting_reporting_artifact,
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_artifact", {}),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact", {}),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_artifact", {}),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact", {}),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact", {}),
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact", {}),
        "downstream_runtime_summary_cli_exposure_usage_reporting_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_artifact", {}),
        "downstream_runtime_summary_cli_exposure_usage_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_artifact", {}),
        "downstream_runtime_summary_cli_exposure_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_artifact", {}),
        "downstream_runtime_summary_reporting_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_reporting_artifact", {}),
        "downstream_runtime_summary_usage_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_usage_artifact", {}),
        "cli_diagnostic_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("cli_diagnostic_artifact", {}),
        "live_fetcher_runtime_summary_artifact": downstream_usage_reporting_reporting_reporting_artifact.get("live_fetcher_runtime_summary_artifact", {}),
    }
    ...
    for field_name in (
        ...
        if field_name in downstream_usage_reporting_reporting_reporting_artifact:
            reporting_reporting_reporting_reporting_artifact[field_name] = downstream_usage_reporting_reporting_reporting_artifact[field_name]

    return reporting_reporting_reporting_reporting_artifact


def _candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting() -> int:
    """Emit module self-check summary with downstream usage reporting-reporting-reporting-reporting fields."""
    ...
    previous_stdout = io.StringIO()
    with contextlib.redirect_stdout(previous_stdout):
        exit_code = _candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting()
    ...
    reporting_reporting_reporting_reporting_artifact = (
        _candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact()
    )

    summary.update(
        {
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_created": reporting_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_created"),
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_version": reporting_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_artifact_version"),
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_status": reporting_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_status"),
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_safe_to_proceed": reporting_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_safe_to_proceed"),
            "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_source": reporting_reporting_reporting_reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting_source"),
        }
    )
...
if __name__ == "__main__":
    raise SystemExit(_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_reporting_reporting())
