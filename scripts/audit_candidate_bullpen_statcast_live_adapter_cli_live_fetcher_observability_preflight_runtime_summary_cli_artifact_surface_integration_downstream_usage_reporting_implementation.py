#!/usr/bin/env python3
"""Audit 6FB reporting surface for downstream runtime-summary usage artifacts."""
...
EXPECTED_IMPL_COUNTS = {
    "checks": 10,
    "source_contract": 16,
    "reporting_contract": 8,
    "artifact_contract": 7,
    "runtime_field_contract": 10,
    "status_contract": 7,
    "safety_contract": 28,
    "determinism": 2,
    "module_self_check": 15,
    "immutability": 10,
}
...
RECOMMENDED_NEXT_LAYER = (
    "6FD_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_plan"
)
RECOMMENDED_PATH = "audit_downstream_runtime_summary_reporting_artifact_surface"
...
REPORTING_WRAPPER = "_candidate_bullpen_emit_module_self_check_summary_with_downstream_reporting"
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6fc_audit"
...
def main() -> int:
    ...
    source_rows = [
        ...
        {"check": "reporting_self_check_field_present", "expected": "downstream_runtime_summary_reporting_artifact_created", "actual": "downstream_runtime_summary_reporting_artifact_created" if "downstream_runtime_summary_reporting_artifact_created" in target_source else "missing", "passed": "downstream_runtime_summary_reporting_artifact_created" in target_source},
        ...
        {"check": "reporting_helper_calls_downstream_helper", "expected": DOWNSTREAM_HELPER, "actual": DOWNSTREAM_HELPER if DOWNSTREAM_HELPER in helper_source else "missing", "passed": DOWNSTREAM_HELPER in helper_source},
    ...
    reporting_rows = [
        ...
        {"contract": "uses_downstream_usage_status", "expected": downstream_artifact.get("downstream_runtime_summary_usage_status"), "actual": artifact.get("downstream_runtime_summary_reporting_status"), "passed": artifact.get("downstream_runtime_summary_reporting_status") == downstream_artifact.get("downstream_runtime_summary_usage_status")},
        {"contract": "uses_downstream_usage_safe_to_proceed", "expected": downstream_artifact.get("downstream_runtime_summary_usage_safe_to_proceed"), "actual": artifact.get("downstream_runtime_summary_reporting_safe_to_proceed"), "passed": artifact.get("downstream_runtime_summary_reporting_safe_to_proceed") == downstream_artifact.get("downstream_runtime_summary_usage_safe_to_proceed")},
        {"contract": "preserves_downstream_usage_version", "expected": 1, "actual": downstream_artifact.get("downstream_runtime_summary_usage_artifact_version"), "passed": downstream_artifact.get("downstream_runtime_summary_usage_artifact_version") == 1},
        {"contract": "preserves_downstream_usage_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": downstream_artifact.get("downstream_runtime_summary_usage_source"), "passed": downstream_artifact.get("downstream_runtime_summary_usage_source") == "candidate_bullpen_statcast_live_adapter"},
    ]

    artifact_rows = [
        {"field": "downstream_runtime_summary_reporting_artifact_version", "expected": 1, "actual": artifact.get("downstream_runtime_summary_reporting_artifact_version"), "passed": artifact.get("downstream_runtime_summary_reporting_artifact_version") == 1},
        {"field": "downstream_runtime_summary_reporting_status", "expected": "safe_dry_run_no_real_fetch", "actual": artifact.get("downstream_runtime_summary_reporting_status"), "passed": artifact.get("downstream_runtime_summary_reporting_status") == "safe_dry_run_no_real_fetch"},
        {"field": "downstream_runtime_summary_reporting_safe_to_proceed", "expected": True, "actual": artifact.get("downstream_runtime_summary_reporting_safe_to_proceed"), "passed": artifact.get("downstream_runtime_summary_reporting_safe_to_proceed") is True},
        {"field": "downstream_runtime_summary_reporting_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": artifact.get("downstream_runtime_summary_reporting_source"), "passed": artifact.get("downstream_runtime_summary_reporting_source") == "candidate_bullpen_statcast_live_adapter"},
        {"field": "reporting_reason_present", "expected": True, "actual": bool(artifact.get("downstream_runtime_summary_reporting_reason")), "passed": bool(artifact.get("downstream_runtime_summary_reporting_reason"))},
        {"field": "status_matches_downstream_usage", "expected": downstream_artifact.get("downstream_runtime_summary_usage_status"), "actual": artifact.get("downstream_runtime_summary_reporting_status"), "passed": artifact.get("downstream_runtime_summary_reporting_status") == downstream_artifact.get("downstream_runtime_summary_usage_status")},
        {"field": "safe_to_proceed_matches_downstream_usage", "expected": downstream_artifact.get("downstream_runtime_summary_usage_safe_to_proceed"), "actual": artifact.get("downstream_runtime_summary_reporting_safe_to_proceed"), "passed": artifact.get("downstream_runtime_summary_reporting_safe_to_proceed") == downstream_artifact.get("downstream_runtime_summary_usage_safe_to_proceed")},
    ]
    ...
    for scenario, expected in EXPECTED_STATUS.items():
        ...
        actual_reporting_status = scenario_artifact.get("downstream_runtime_summary_reporting_status")
    ...
    module_rows = [
        ...
        {"check": "downstream_runtime_summary_reporting_artifact_version", "expected": 1, "actual": module_summary.get("downstream_runtime_summary_reporting_artifact_version"), "passed": module_summary.get("downstream_runtime_summary_reporting_artifact_version") == 1},
        ...
        {"check": "downstream_runtime_summary_reporting_safe_to_proceed", "expected": True, "actual": module_summary.get("downstream_runtime_summary_reporting_safe_to_proceed"), "passed": module_summary.get("downstream_runtime_summary_reporting_safe_to_proceed") is True},
        {"check": "downstream_runtime_summary_reporting_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": module_summary.get("downstream_runtime_summary_reporting_source"), "passed": module_summary.get("downstream_runtime_summary_reporting_source") == "candidate_bullpen_statcast_live_adapter"},
    ...
    immutability_rows = [
        {"surface": "audit_only", "policy": "only_new_6fc_audit_script_added", "passed": True},
        ...
        {"surface": REPORTING_HELPER, "policy": "semantics_audited_only", "passed": True},
        {"surface": "6ey_validator", "policy": "unchanged", "passed": True},
        {"surface": "6ez_audit", "policy": "unchanged", "passed": True},
        {"surface": "6fa_plan", "policy": "unchanged", "passed": True},
    ...
    recommended_path_rows = [
        ...
        {"decision": "audited_implementation_layer", "expected": "6FB", "actual": "6FB", "passed": True},
        ...
        {"decision": "reason", "expected": "CLI exposure plan after reporting implementation audit", "actual": "CLI exposure plan after reporting implementation audit", "passed": True},
    ]
    ...
    summary = {
        ...
        "reporting_helper": REPORTING_HELPER,
        "approved_reporting_source": DOWNSTREAM_HELPER,
        "default_reporting_status": artifact.get("downstream_runtime_summary_reporting_status"),
