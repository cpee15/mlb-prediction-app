#!/usr/bin/env python3
"""Audit 6FH downstream usage surface for CLI exposure runtime-summary artifacts."""
...
IMPL_ARTIFACTS = {
    ...
    "usage_contract": TMP_DIR / f"{IMPL_SLUG}_usage_contract.csv",
...
AUDIT_USAGE_CONTRACT_CSV = TMP_DIR / f"{AUDIT_SLUG}_usage_contract.csv"
...
RECOMMENDED_NEXT_LAYER = (
    "6FJ_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_plan"
)
RECOMMENDED_PATH = "audit_downstream_runtime_summary_cli_exposure_usage_artifact_surface"
...
USAGE_WRAPPER = "_candidate_bullpen_emit_module_self_check_summary_with_cli_exposure_usage"
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6fi_audit"
...
def main() -> int:
    ...
    helper_source = inspect.getsource(usage_helper) if usage_helper is not None else ""
    ...
    source_rows = [
        ...
        {"check": "usage_wrapper_present", "expected": USAGE_WRAPPER, "actual": USAGE_WRAPPER if USAGE_WRAPPER in target_source else "missing", "passed": USAGE_WRAPPER in target_source},
        {"check": "usage_self_check_created_field_present", "expected": "downstream_runtime_summary_cli_exposure_usage_artifact_created", "actual": "downstream_runtime_summary_cli_exposure_usage_artifact_created" if "downstream_runtime_summary_cli_exposure_usage_artifact_created" in target_source else "missing", "passed": "downstream_runtime_summary_cli_exposure_usage_artifact_created" in target_source},
        {"check": "usage_self_check_status_field_present", "expected": "downstream_runtime_summary_cli_exposure_usage_status", "actual": "downstream_runtime_summary_cli_exposure_usage_status" if "downstream_runtime_summary_cli_exposure_usage_status" in target_source else "missing", "passed": "downstream_runtime_summary_cli_exposure_usage_status" in target_source},
        ...
        {"check": "reporting_artifact_surface_present", "expected": "downstream_runtime_summary_reporting_artifact", "actual": "downstream_runtime_summary_reporting_artifact" if "downstream_runtime_summary_reporting_artifact" in target_source else "missing", "passed": "downstream_runtime_summary_reporting_artifact" in target_source},
        ...
        {"check": "usage_helper_calls_cli_exposure_helper", "expected": CLI_EXPOSURE_HELPER, "actual": CLI_EXPOSURE_HELPER if CLI_EXPOSURE_HELPER in helper_source else "missing", "passed": CLI_EXPOSURE_HELPER in helper_source},
    ...
    artifact = usage_helper() if usage_helper is not None else {}
    ...
    usage_rows = [
        ...
        {"contract": "uses_cli_exposure_status", "expected": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_status"), "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_status"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_status") == cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_status")},
        {"contract": "uses_cli_exposure_safe_to_proceed", "expected": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_safe_to_proceed"), "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed") == cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_safe_to_proceed")},
        {"contract": "preserves_cli_exposure_version", "expected": 1, "actual": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_artifact_version"), "passed": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_artifact_version") == 1},
        {"contract": "preserves_cli_exposure_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_source"), "passed": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_source") == "candidate_bullpen_statcast_live_adapter"},
    ]

    artifact_rows = [
        {"field": "downstream_runtime_summary_cli_exposure_usage_artifact_version", "expected": 1, "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_artifact_version"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_artifact_version") == 1},
        {"field": "downstream_runtime_summary_cli_exposure_usage_status", "expected": "safe_dry_run_no_real_fetch", "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_status"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_status") == "safe_dry_run_no_real_fetch"},
        {"field": "downstream_runtime_summary_cli_exposure_usage_safe_to_proceed", "expected": True, "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed") is True},
        {"field": "downstream_runtime_summary_cli_exposure_usage_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_source"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_source") == "candidate_bullpen_statcast_live_adapter"},
        {"field": "usage_reason_present", "expected": True, "actual": bool(artifact.get("downstream_runtime_summary_cli_exposure_usage_reason")), "passed": bool(artifact.get("downstream_runtime_summary_cli_exposure_usage_reason"))},
        {"field": "status_matches_cli_exposure", "expected": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_status"), "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_status"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_status") == cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_status")},
        {"field": "safe_to_proceed_matches_cli_exposure", "expected": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_safe_to_proceed"), "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed") == cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_safe_to_proceed")},
    ]
    ...
    for scenario, expected in EXPECTED_STATUS.items():
        ...
        actual_usage_status = scenario_artifact.get("downstream_runtime_summary_cli_exposure_usage_status")
    ...
    module_rows = [
        ...
        {"check": "downstream_runtime_summary_cli_exposure_usage_artifact_version", "expected": 1, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_artifact_version"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_artifact_version") == 1},
        ...
        {"check": "downstream_runtime_summary_cli_exposure_usage_safe_to_proceed", "expected": True, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed") is True},
        {"check": "downstream_runtime_summary_cli_exposure_usage_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_source"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_source") == "candidate_bullpen_statcast_live_adapter"},
    ...
    immutability_rows = [
        {"surface": "audit_only", "policy": "only_new_6fi_audit_script_added", "passed": True},
        ...
        {"surface": USAGE_HELPER, "policy": "semantics_audited_only", "passed": True},
        {"surface": "6fe_validator", "policy": "unchanged", "passed": True},
        {"surface": "6ff_audit", "policy": "unchanged", "passed": True},
        {"surface": "6fg_plan", "policy": "unchanged", "passed": True},
    ...
    recommended_path_rows = [
        ...
        {"decision": "audited_implementation_layer", "expected": "6FH", "actual": "6FH", "passed": True},
        ...
        {"decision": "reason", "expected": "Reporting plan after CLI exposure usage implementation audit", "actual": "Reporting plan after CLI exposure usage implementation audit", "passed": True},
    ]
    ...
    csv_counts = {
        ...
        "usage_contract": write_csv(AUDIT_USAGE_CONTRACT_CSV, usage_rows),
    ...
    summary = {
        ...
        "default_usage_status": artifact.get("downstream_runtime_summary_cli_exposure_usage_status"),
        ...
        "artifact_paths": {
            ...
            "usage_contract_csv": str(AUDIT_USAGE_CONTRACT_CSV),
