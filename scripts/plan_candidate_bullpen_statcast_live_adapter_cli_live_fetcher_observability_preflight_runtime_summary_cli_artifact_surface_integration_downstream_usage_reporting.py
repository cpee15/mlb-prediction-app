#!/usr/bin/env python3
"""Plan reporting for downstream runtime-summary usage artifacts."""
...
PLAN_SLUG = (
    ...
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_plan"
)
IMPL_SLUG_6EY = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_implementation"
)
AUDIT_SLUG_6EZ = f"{IMPL_SLUG_6EY}_audit"

TMP_DIR = Path("tmp")
TARGET_PATH = Path("scripts/fetch_candidate_bullpen_statcast_live_adapter.py")
VALIDATOR_6EY_PATH = Path(
    "scripts/validate_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_"
    "observability_preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_implementation.py"
)
AUDIT_6EZ_PATH = Path(
...
IMPL_JSON_6EY = TMP_DIR / f"{IMPL_SLUG_6EY}.json"
AUDIT_JSON_6EZ = TMP_DIR / f"{AUDIT_SLUG_6EZ}.json"

PLAN_DIAGNOSIS = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_plan_complete"
)
RECOMMENDED_NEXT_LAYER = (
    "6FB_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_implementation"
)
FUTURE_AUDIT_LAYER = (
    "6FC_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_implementation_audit"
)
RECOMMENDED_PATH = "surface_downstream_runtime_summary_usage_artifact_in_reporting"
...
DIAGNOSIS_6EZ = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_implementation_audit_complete"
)
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6fa_plan"
...
def main() -> int:
    ...
    validator_run = subprocess.run(
        [sys.executable, str(VALIDATOR_6EY_PATH)],
        check=False,
        text=True,
        capture_output=True,
    )
    audit_run = subprocess.run(
        [sys.executable, str(AUDIT_6EZ_PATH)],
        check=False,
        text=True,
        capture_output=True,
    )
    ...
    impl_summary = load_json(IMPL_JSON_6EY)
    audit_summary = load_json(AUDIT_JSON_6EZ)
    try:
    ...
    downstream_artifact = downstream_helper() if downstream_helper is not None else {}
    ...
    prerequisites_rows = [
        ...
        {"prerequisite": "6ey_validator_exists", "expected": True, "actual": VALIDATOR_6EY_PATH.exists(), "passed": VALIDATOR_6EY_PATH.exists()},
        {"prerequisite": "6ey_validator_passes", "expected": 0, "actual": validator_run.returncode, "passed": validator_run.returncode == 0},
        {"prerequisite": "6ey_json_passed", "expected": True, "actual": impl_summary.get("all_checks_passed"), "passed": impl_summary.get("all_checks_passed") is True},
        {"prerequisite": "6ey_diagnosis", "expected": DIAGNOSIS_6EY, "actual": impl_summary.get("diagnosis"), "passed": impl_summary.get("diagnosis") == DIAGNOSIS_6EY},
        {"prerequisite": "6ez_audit_exists", "expected": True, "actual": AUDIT_6EZ_PATH.exists(), "passed": AUDIT_6EZ_PATH.exists()},
        {"prerequisite": "6ez_audit_passes", "expected": 0, "actual": audit_run.returncode, "passed": audit_run.returncode == 0},
        {"prerequisite": "6ez_json_passed", "expected": True, "actual": audit_summary.get("all_checks_passed"), "passed": audit_summary.get("all_checks_passed") is True},
        {"prerequisite": "6ez_diagnosis", "expected": DIAGNOSIS_6EZ, "actual": audit_summary.get("diagnosis"), "passed": audit_summary.get("diagnosis") == DIAGNOSIS_6EZ},
        {"prerequisite": "module_self_check_passes", "expected": 0, "actual": module_run.returncode, "passed": module_run.returncode == 0},
        {"prerequisite": "module_downstream_created", "expected": True, "actual": module_summary.get("downstream_runtime_summary_usage_artifact_created"), "passed": module_summary.get("downstream_runtime_summary_usage_artifact_created") is True},
        {"prerequisite": "module_downstream_version", "expected": 1, "actual": module_summary.get("downstream_runtime_summary_usage_artifact_version"), "passed": module_summary.get("downstream_runtime_summary_usage_artifact_version") == 1},
        {"prerequisite": "module_downstream_status", "expected": "safe_dry_run_no_real_fetch", "actual": module_summary.get("downstream_runtime_summary_usage_status"), "passed": module_summary.get("downstream_runtime_summary_usage_status") == "safe_dry_run_no_real_fetch"},
        {"prerequisite": "module_downstream_safe_to_proceed", "expected": True, "actual": module_summary.get("downstream_runtime_summary_usage_safe_to_proceed"), "passed": module_summary.get("downstream_runtime_summary_usage_safe_to_proceed") is True},
        {"prerequisite": "module_downstream_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": module_summary.get("downstream_runtime_summary_usage_source"), "passed": module_summary.get("downstream_runtime_summary_usage_source") == "candidate_bullpen_statcast_live_adapter"},
    ...
    source_surface_rows = [
        {"surface": DOWNSTREAM_HELPER, "role": "only_approved_reporting_source", "required": True, "actual": DOWNSTREAM_HELPER in target_source, "passed": DOWNSTREAM_HELPER in target_source},
        ...
        {"surface": "downstream_runtime_summary_usage_artifact_created", "role": "module_self_check_reporting_prerequisite", "required": True, "actual": "downstream_runtime_summary_usage_artifact_created" in target_source, "passed": "downstream_runtime_summary_usage_artifact_created" in target_source},
    ...
    reporting_rows = [
        {"contract": "approved_reporting_source", "requirement": DOWNSTREAM_HELPER, "passed": True},
        ...
        {"contract": "surface_downstream_version", "requirement": "downstream_runtime_summary_usage_artifact_version", "passed": True},
        {"contract": "surface_downstream_status", "requirement": "downstream_runtime_summary_usage_status", "passed": True},
        {"contract": "surface_downstream_safe_to_proceed", "requirement": "downstream_runtime_summary_usage_safe_to_proceed", "passed": True},
        {"contract": "surface_downstream_source", "requirement": "downstream_runtime_summary_usage_source", "passed": True},
        {"contract": "surface_downstream_reason", "requirement": "downstream_runtime_summary_usage_reason", "passed": True},
    ...
    artifact_rows = [
        {"field": "artifact_is_dict", "expected": True, "actual": isinstance(downstream_artifact, dict), "passed": isinstance(downstream_artifact, dict)},
        {"field": "downstream_runtime_summary_usage_artifact_version", "expected": 1, "actual": downstream_artifact.get("downstream_runtime_summary_usage_artifact_version"), "passed": downstream_artifact.get("downstream_runtime_summary_usage_artifact_version") == 1},
        {"field": "downstream_runtime_summary_usage_status", "expected": "safe_dry_run_no_real_fetch", "actual": downstream_artifact.get("downstream_runtime_summary_usage_status"), "passed": downstream_artifact.get("downstream_runtime_summary_usage_status") == "safe_dry_run_no_real_fetch"},
        {"field": "downstream_runtime_summary_usage_safe_to_proceed", "expected": True, "actual": downstream_artifact.get("downstream_runtime_summary_usage_safe_to_proceed"), "passed": downstream_artifact.get("downstream_runtime_summary_usage_safe_to_proceed") is True},
        {"field": "downstream_runtime_summary_usage_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": downstream_artifact.get("downstream_runtime_summary_usage_source"), "passed": downstream_artifact.get("downstream_runtime_summary_usage_source") == "candidate_bullpen_statcast_live_adapter"},
        ...
        {"field": "status_alignment", "expected": runtime_artifact.get("live_fetcher_runtime_summary_status"), "actual": downstream_artifact.get("downstream_runtime_summary_usage_status"), "passed": downstream_artifact.get("downstream_runtime_summary_usage_status") == cli_artifact.get("cli_diagnostic_artifact_status") == runtime_artifact.get("live_fetcher_runtime_summary_status")},
        {"field": "safe_to_proceed_alignment", "expected": runtime_artifact.get("live_fetcher_runtime_summary_safe_to_proceed"), "actual": downstream_artifact.get("downstream_runtime_summary_usage_safe_to_proceed"), "passed": downstream_artifact.get("downstream_runtime_summary_usage_safe_to_proceed") == cli_artifact.get("cli_diagnostic_artifact_safe_to_proceed") == runtime_artifact.get("live_fetcher_runtime_summary_safe_to_proceed")},
        {"field": "runtime_field_version", "expected": 1, "actual": downstream_artifact.get("live_fetcher_runtime_summary_field_version"), "passed": downstream_artifact.get("live_fetcher_runtime_summary_field_version") == 1},
    ]
        ...
        runtime_field_rows.append(
            {
                ...
                and downstream_artifact.get(field) == cli_artifact.get(field) == runtime_artifact.get(field),
            }
        )
    ...
    validation_rows = [
        {"validation": "compileall", "required_for_6fb": True, "passed": True},
        {"validation": "module_self_check", "required_for_6fb": True, "passed": True},
        {"validation": "reporting_usage_validator", "required_for_6fb": True, "passed": True},
        {"validation": "artifact_json_exists", "required_for_6fb": True, "passed": True},
        {"validation": "all_emitted_csv_rows_pass", "required_for_6fb": True, "passed": True},
        {"validation": "source_contract", "required_for_6fb": True, "passed": True},
        {"validation": "reporting_contract", "required_for_6fb": True, "passed": True},
        {"validation": "artifact_contract", "required_for_6fb": True, "passed": True},
        {"validation": "runtime_field_contract", "required_for_6fb": True, "passed": True},
        {"validation": "status_contract", "required_for_6fb": True, "passed": True},
        {"validation": "safety_contract", "required_for_6fb": True, "passed": True},
        {"validation": "determinism_contract", "required_for_6fb": True, "passed": True},
        {"validation": "immutability_contract", "required_for_6fb": True, "passed": True},
    ]
    ...
    immutability_rows = [
        ...
        {"surface": "6ey_validator", "policy": "unchanged", "passed": True},
        {"surface": "6ez_audit", "policy": "unchanged", "passed": True},
    ...
    recommended_path_rows = [
        ...
        {"decision": "implementation_scope", "expected": "surface existing downstream usage artifact only", "actual": "surface existing downstream usage artifact only", "passed": True},
    ]
    ...
    summary = {
        ...
        "approved_reporting_source": DOWNSTREAM_HELPER,
        ...
        "validator_6ey_returncode": validator_run.returncode,
        "audit_6ez_returncode": audit_run.returncode,
