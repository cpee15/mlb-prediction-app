#!/usr/bin/env python3
"""Validate 6FK reporting surface for CLI exposure usage runtime-summary artifacts."""
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6fk_validator"
...
def main() -> int:
    ...
    helper_source = inspect.getsource(reporting_helper) if reporting_helper else ""

    source_rows = [
        {"check": "reporting_helper_exists", "expected": True, "actual": reporting_helper is not None, "passed": reporting_helper is not None},
        ...
        {"check": "module_self_check_reporting_wrapper_exists", "expected": True, "actual": "_candidate_bullpen_emit_module_self_check_summary_with_cli_exposure_usage_reporting" in target_source, "passed": "_candidate_bullpen_emit_module_self_check_summary_with_cli_exposure_usage_reporting" in target_source},
        {"check": "entrypoint_uses_reporting_wrapper", "expected": True, "actual": "raise SystemExit(_candidate_bullpen_emit_module_self_check_summary_with_cli_exposure_usage_reporting())" in target_source, "passed": "raise SystemExit(_candidate_bullpen_emit_module_self_check_summary_with_cli_exposure_usage_reporting())" in target_source},
    ]
    ...
    artifact = reporting_helper() if reporting_helper else {}
