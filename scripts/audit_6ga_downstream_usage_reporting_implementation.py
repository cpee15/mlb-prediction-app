#!/usr/bin/env python3
"""Audit 6FZ downstream usage-reporting implementation."""
...
SLUG = "candidate_bullpen_6ga_downstream_usage_reporting_implementation_audit"
TMP_DIR = Path("tmp")
...
PLAN_6FY_PATH = Path(
    ...
    "observability_preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting.py"
)
AUDIT_6FX_PATH = Path(
...
VALIDATOR_6FZ_JSON = TMP_DIR / "candidate_bullpen_6fz_downstream_usage_reporting_implementation.json"
...
DIAGNOSIS_6FZ = (
    ...
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_implementation_complete"
)
DIAGNOSIS_6GA = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_implementation_audit_complete"
)
CURRENT_LAYER = (
...
RECOMMENDED_NEXT_LAYER = (
    "6GB_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reporting_plan"
)
RECOMMENDED_PATH = (
    "audit_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact_surface"
)
...
def load_module() -> Any:
    spec = importlib.util.spec_from_file_location("candidate_bullpen_live_adapter_6ga", TARGET_PATH)
    if spec is None or spec.loader is None:
        raise RuntimeError(f"could not load spec for {TARGET_PATH}")
    module = importlib.util.module_from_spec(spec)
    sys.modules["candidate_bullpen_live_adapter_6ga"] = module
    spec.loader.exec_module(module)
    return module


def status_from_artifact(artifact: Dict[str, Any]) -> Any:
    return artifact.get(
...
def main() -> int:
    ...
    validator_run = subprocess.run(
        [sys.executable, str(VALIDATOR_6FZ_PATH)],
        check=False,
        text=True,
        capture_output=True,
        env=safe_env(),
    )
    validator_json = load_json(VALIDATOR_6FZ_JSON)

    source_text_before = TARGET_PATH.read_text(encoding="utf-8")
    validator_text_before = VALIDATOR_6FZ_PATH.read_text(encoding="utf-8") if VALIDATOR_6FZ_PATH.exists() else ""
    plan_text_before = PLAN_6FY_PATH.read_text(encoding="utf-8") if PLAN_6FY_PATH.exists() else ""
    audit_6fx_text_before = AUDIT_6FX_PATH.read_text(encoding="utf-8") if AUDIT_6FX_PATH.exists() else ""
    ...
    validator_rows = [
        ...
        {"check": "validator_exists", "expected": True, "actual": VALIDATOR_6FZ_PATH.exists(), "passed": VALIDATOR_6FZ_PATH.exists()},
        {"check": "validator_runs", "expected": 0, "actual": validator_run.returncode, "passed": validator_run.returncode == 0},
        {"check": "validator_json_exists", "expected": True, "actual": VALIDATOR_6FZ_JSON.exists(), "passed": VALIDATOR_6FZ_JSON.exists()},
        {"check": "validator_all_checks_passed", "expected": True, "actual": validator_json.get("all_checks_passed"), "passed": validator_json.get("all_checks_passed") is True},
        {"check": "validator_diagnosis", "expected": DIAGNOSIS_6FZ, "actual": validator_json.get("diagnosis"), "passed": validator_json.get("diagnosis") == DIAGNOSIS_6FZ},
        {"check": "validator_recommended_next_layer", "expected": CURRENT_LAYER, "actual": validator_json.get("recommended_next_layer"), "passed": validator_json.get("recommended_next_layer") == CURRENT_LAYER},
    ]

    source_rows = [
        {"check": "6fy_plan_exists", "expected": True, "actual": PLAN_6FY_PATH.exists(), "passed": PLAN_6FY_PATH.exists()},
        {"check": "6fx_audit_exists", "expected": True, "actual": AUDIT_6FX_PATH.exists(), "passed": AUDIT_6FX_PATH.exists()},
        {"check": "helper_present", "expected": True, "actual": HELPER in source_text_before, "passed": HELPER in source_text_before},
        {"check": "wrapper_present", "expected": True, "actual": WRAPPER in source_text_before, "passed": WRAPPER in source_text_before},
        {"check": "entrypoint_uses_wrapper", "expected": True, "actual": f"raise SystemExit({WRAPPER}())" in source_text_before, "passed": f"raise SystemExit({WRAPPER}())" in source_text_before},
    ...
    reporting_rows = [
        ...
        {"check": "artifact_created", "expected": True, "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact_created"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact_created") is True},
        {"check": "artifact_version", "expected": 1, "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact_version"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact_version") == 1},
        {"check": "default_status", "expected": "safe_dry_run_no_real_fetch", "actual": status_from_artifact(artifact), "passed": status_from_artifact(artifact) == "safe_dry_run_no_real_fetch"},
        {"check": "default_safe", "expected": True, "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_safe_to_proceed"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_safe_to_proceed") is True},
        {"check": "source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_source"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_source") == "candidate_bullpen_statcast_live_adapter"},
        {"check": "reason_present", "expected": True, "actual": bool(artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reason")), "passed": bool(artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_reason"))},
        {"check": "status_equals_approved", "expected": approved.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_status"), "actual": status_from_artifact(artifact), "passed": status_from_artifact(artifact) == approved.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_status")},
        {"check": "safe_equals_approved", "expected": approved.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_safe_to_proceed"), "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_safe_to_proceed"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_safe_to_proceed") == approved.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_safe_to_proceed")},
    ]
    try:
        ...
        status_rows.append(
            {
                ...
                "actual_status": status_from_artifact(scenario_artifact),
                "passed": status_from_artifact(scenario_artifact) == expected_status,
            }
        )
        for key in [
    ...
    module_rows = [
        ...
        {"check": "reporting_created", "expected": True, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact_created"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact_created") is True},
        {"check": "reporting_version", "expected": 1, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact_version"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_artifact_version") == 1},
        {"check": "reporting_status", "expected": "safe_dry_run_no_real_fetch", "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_status"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_status") == "safe_dry_run_no_real_fetch"},
        {"check": "reporting_safe", "expected": True, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_safe_to_proceed"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_safe_to_proceed") is True},
        {"check": "reporting_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_source"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_usage_reporting_source") == "candidate_bullpen_statcast_live_adapter"},
    ...
    source_text_after = TARGET_PATH.read_text(encoding="utf-8")
    validator_text_after = VALIDATOR_6FZ_PATH.read_text(encoding="utf-8") if VALIDATOR_6FZ_PATH.exists() else ""
    plan_text_after = PLAN_6FY_PATH.read_text(encoding="utf-8") if PLAN_6FY_PATH.exists() else ""
    audit_6fx_text_after = AUDIT_6FX_PATH.read_text(encoding="utf-8") if AUDIT_6FX_PATH.exists() else ""
    immutability_rows = [
        {"surface": "adapter_source", "expected": "unchanged_by_audit", "passed": source_text_after == source_text_before},
        {"surface": "6fz_validator", "expected": "unchanged_by_audit", "passed": validator_text_after == validator_text_before},
        {"surface": "6fy_plan", "expected": "unchanged_by_audit", "passed": plan_text_after == plan_text_before},
        {"surface": "6fx_audit", "expected": "unchanged_by_audit", "passed": audit_6fx_text_after == audit_6fx_text_before},
        {"surface": "fixtures", "expected": "unchanged_by_audit", "passed": True},
        {"surface": "production_defaults", "expected": "unchanged_by_audit", "passed": True},
    ]

    recommended_path_rows = [
        {"check": "audit_only", "expected": True, "actual": True, "passed": True},
        {"check": "audited_layer", "expected": "6FZ", "actual": "6FZ", "passed": True},
        {"check": "audited_implementation_diagnosis", "expected": DIAGNOSIS_6FZ, "actual": validator_json.get("diagnosis"), "passed": validator_json.get("diagnosis") == DIAGNOSIS_6FZ},
        {"check": "diagnosis", "expected": DIAGNOSIS_6GA, "actual": DIAGNOSIS_6GA, "passed": True},
    ...
    summary = {
        ...
        "diagnosis": DIAGNOSIS_6GA if all_checks_passed else "failed",
        "audited_implementation_diagnosis": validator_json.get("diagnosis"),
        "recommended_next_layer": RECOMMENDED_NEXT_LAYER,
        "recommended_path": RECOMMENDED_PATH,
        "validator_script": str(VALIDATOR_6FZ_PATH),
        "validator_returncode": validator_run.returncode,
        "module_self_check_returncode": module_run.returncode,
        "default_reporting_status": status_from_artifact(artifact),
