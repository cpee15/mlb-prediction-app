#!/usr/bin/env python3
"""Validate 6FT downstream-facing surface for usage artifacts."""
...
# Keep emitted artifact paths short enough for macOS filesystem limits.
SLUG = "candidate_bullpen_6ft_downstream_implementation"
TMP_DIR = Path("tmp")
...
DOWNSTREAM_CONTRACT_CSV = TMP_DIR / f"{SLUG}_downstream_contract.csv"
...
DOWNSTREAM_HELPER_NEW = "_candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact"
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6ft_validator"
...
def main() -> int:
    ...
    module = load_module()
    downstream_helper = getattr(module, DOWNSTREAM_HELPER_NEW, None)
    ...
    source_rows = [
        ...
        {"check": "downstream_helper_calls_approved_downstream_source", "expected": APPROVED_DOWNSTREAM_SOURCE, "actual": APPROVED_DOWNSTREAM_SOURCE if APPROVED_DOWNSTREAM_SOURCE in helper_source else "missing", "passed": APPROVED_DOWNSTREAM_SOURCE in helper_source},
        {"check": "downstream_helper_avoids_direct_usage_source", "expected": "absent", "actual": "present" if APPROVED_USAGE_SOURCE in helper_source else "absent", "passed": APPROVED_USAGE_SOURCE not in helper_source},
        {"check": "downstream_helper_avoids_direct_reporting_helper", "expected": "absent", "actual": "present" if REPORTING_HELPER in helper_source else "absent", "passed": REPORTING_HELPER not in helper_source},
        {"check": "downstream_helper_avoids_direct_prior_usage_helper", "expected": "absent", "actual": "present" if PRIOR_USAGE_HELPER in helper_source else "absent", "passed": PRIOR_USAGE_HELPER not in helper_source},
        {"check": "downstream_helper_avoids_direct_prior_cli_exposure_helper", "expected": "absent", "actual": "present" if PRIOR_CLI_EXPOSURE_HELPER in helper_source else "absent", "passed": PRIOR_CLI_EXPOSURE_HELPER not in helper_source},
        {"check": "downstream_helper_avoids_direct_upstream_reporting_helper", "expected": "absent", "actual": "present" if UPSTREAM_REPORTING_HELPER in helper_source else "absent", "passed": UPSTREAM_REPORTING_HELPER not in helper_source},
        {"check": "downstream_helper_avoids_direct_downstream_usage_helper", "expected": "absent", "actual": "present" if DOWNSTREAM_USAGE_HELPER in helper_source else "absent", "passed": DOWNSTREAM_USAGE_HELPER not in helper_source},
        {"check": "downstream_helper_avoids_direct_cli_helper", "expected": "absent", "actual": "present" if CLI_HELPER in helper_source else "absent", "passed": CLI_HELPER not in helper_source},
        ...
        {"check": "module_self_check_downstream_wrapper_exists", "expected": True, "actual": "_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream" in target_source, "passed": "_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream" in target_source},
        {"check": "entrypoint_uses_downstream_wrapper", "expected": True, "actual": "raise SystemExit(_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream())" in target_source, "passed": "raise SystemExit(_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream())" in target_source},
    ]
    ...
    downstream_rows = [
        ...
        {"contract": "uses_usage_status", "expected": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status"), "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_status"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_status") == usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status")},
        {"contract": "uses_usage_safe_to_proceed", "expected": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_safe_to_proceed"), "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_safe_to_proceed"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_safe_to_proceed") == usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_safe_to_proceed")},
        {"contract": "preserves_usage_version", "expected": 1, "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_version"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_version") == 1},
        {"contract": "preserves_usage_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_source"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_source") == "candidate_bullpen_statcast_live_adapter"},
    ]

    artifact_rows = [
        {"field": "downstream_version", "expected": 1, "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact_version"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact_version") == 1},
        {"field": "downstream_status", "expected": "safe_dry_run_no_real_fetch", "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_status"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_status") == "safe_dry_run_no_real_fetch"},
        {"field": "downstream_safe_to_proceed", "expected": True, "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_safe_to_proceed"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_safe_to_proceed") is True},
        {"field": "downstream_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_source"), "passed": artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_source") == "candidate_bullpen_statcast_live_adapter"},
        {"field": "downstream_reason_present", "expected": True, "actual": bool(artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_reason")), "passed": bool(artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_reason"))},
    ...
    for scenario, expected in EXPECTED_STATUS.items():
        ...
        actual_downstream_status = scenario_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_status")
        actual_usage_status = scenario_usage.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status")
        ...
        actual_prior_usage_status = scenario_prior_usage.get("downstream_runtime_summary_cli_exposure_usage_status")
        ...
        actual_downstream_usage_status = scenario_downstream_usage.get("downstream_runtime_summary_usage_status")
        ...
        status_rows.append(
            {
                ...
                "actual_prior_usage_status": actual_prior_usage_status,
            ...
            safety_rows.append(
                {
                    ...
                    "prior_usage_actual": scenario_prior_usage.get(safety_key),
                    ...
                    "downstream_usage_actual": scenario_downstream_usage.get(safety_key),
    ...
    csv_counts = {
        ...
        "downstream_contract": write_csv(DOWNSTREAM_CONTRACT_CSV, downstream_rows),
    ...
    summary = {
        ...
        "downstream_helper": DOWNSTREAM_HELPER_NEW,
        ...
        "artifact_paths": {
            ...
            "downstream_contract_csv": str(DOWNSTREAM_CONTRACT_CSV),
