#!/usr/bin/env python3
"""Validate 6FB reporting surface for downstream runtime-summary usage artifacts."""
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6fb_validator"
...
def main() -> int:
    ...
    source_rows = [
        ...
        {"check": "module_self_check_reporting_wrapper_exists", "expected": True, "actual": "_candidate_bullpen_emit_module_self_check_summary_with_downstream_reporting" in target_source, "passed": "_candidate_bullpen_emit_module_self_check_summary_with_downstream_reporting" in target_source},
        {"check": "entrypoint_uses_reporting_wrapper", "expected": True, "actual": "raise SystemExit(_candidate_bullpen_emit_module_self_check_summary_with_downstream_reporting())" in target_source, "passed": "raise SystemExit(_candidate_bullpen_emit_module_self_check_summary_with_downstream_reporting())" in target_source},
    ]
