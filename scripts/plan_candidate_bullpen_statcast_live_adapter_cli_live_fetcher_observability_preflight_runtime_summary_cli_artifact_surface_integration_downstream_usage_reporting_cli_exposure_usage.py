#!/usr/bin/env python3
"""Plan downstream usage of CLI exposure runtime-summary artifacts."""
...
PLAN_SLUG = (
    ...
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_plan"
)
IMPL_SLUG_6FE = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_implementation"
)
AUDIT_SLUG_6FF = f"{IMPL_SLUG_6FE}_audit"

TMP_DIR = Path("tmp")
TARGET_PATH = Path("scripts/fetch_candidate_bullpen_statcast_live_adapter.py")
VALIDATOR_6FE_PATH = Path(
    "scripts/validate_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_"
    "observability_preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_implementation.py"
)
AUDIT_6FF_PATH = Path(
...
IMPL_JSON_6FE = TMP_DIR / f"{IMPL_SLUG_6FE}.json"
AUDIT_JSON_6FF = TMP_DIR / f"{AUDIT_SLUG_6FF}.json"

PLAN_DIAGNOSIS = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_plan_complete"
)
RECOMMENDED_NEXT_LAYER = (
    "6FH_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_implementation"
)
FUTURE_AUDIT_LAYER = (
    "6FI_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_implementation_audit"
)
RECOMMENDED_PATH = "consume_downstream_runtime_summary_cli_exposure_artifact_in_downstream_usage_surface"
...
DIAGNOSIS_6FF = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_implementation_audit_complete"
)
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6fg_plan"
...
def main() -> int:
    ...
    validator_run = subprocess.run(
        [sys.executable, str(VALIDATOR_6FE_PATH)],
        check=False,
        text=True,
        capture_output=True,
    )
    audit_run = subprocess.run(
        [sys.executable, str(AUDIT_6FF_PATH)],
        check=False,
        text=True,
        capture_output=True,
    )
    ...
    impl_summary = load_json(IMPL_JSON_6FE)
    audit_summary = load_json(AUDIT_JSON_6FF)
    try:
    ...
    reporting_artifact = cli_exposure_artifact.get("downstream_runtime_summary_reporting_artifact", {})
    ...
    prerequisites_rows = [
        ...
        {"prerequisite": "6fe_validator_exists", "expected": True, "actual": VALIDATOR_6FE_PATH.exists(), "passed": VALIDATOR_6FE_PATH.exists()},
        {"prerequisite": "6fe_validator_passes", "expected": 0, "actual": validator_run.returncode, "passed": validator_run.returncode == 0},
        {"prerequisite": "6fe_json_passed", "expected": True, "actual": impl_summary.get("all_checks_passed"), "passed": impl_summary.get("all_checks_passed") is True},
        {"prerequisite": "6fe_diagnosis", "expected": DIAGNOSIS_6FE, "actual": impl_summary.get("diagnosis"), "passed": impl_summary.get("diagnosis") == DIAGNOSIS_6FE},
        {"prerequisite": "6ff_audit_exists", "expected": True, "actual": AUDIT_6FF_PATH.exists(), "passed": AUDIT_6FF_PATH.exists()},
        {"prerequisite": "6ff_audit_passes", "expected": 0, "actual": audit_run.returncode, "passed": audit_run.returncode == 0},
        {"prerequisite": "6ff_json_passed", "expected": True, "actual": audit_summary.get("all_checks_passed"), "passed": audit_summary.get("all_checks_passed") is True},
        {"prerequisite": "6ff_diagnosis", "expected": DIAGNOSIS_6FF, "actual": audit_summary.get("diagnosis"), "passed": audit_summary.get("diagnosis") == DIAGNOSIS_6FF},
        ...
        {"prerequisite": "module_cli_exposure_version", "expected": 1, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_artifact_version"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_artifact_version") == 1},
        ...
        {"prerequisite": "module_cli_exposure_safe_to_proceed", "expected": True, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_safe_to_proceed"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_safe_to_proceed") is True},
        {"prerequisite": "module_cli_exposure_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": module_summary.get("downstream_runtime_summary_cli_exposure_source"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_source") == "candidate_bullpen_statcast_live_adapter"},
    ...
    source_surface_rows = [
        {"surface": CLI_EXPOSURE_HELPER, "role": "only_approved_downstream_usage_source", "required": True, "actual": CLI_EXPOSURE_HELPER in target_source, "passed": CLI_EXPOSURE_HELPER in target_source},
        ...
        {"surface": "downstream_runtime_summary_cli_exposure_artifact_created", "role": "module_self_check_usage_prerequisite", "required": True, "actual": "downstream_runtime_summary_cli_exposure_artifact_created" in target_source, "passed": "downstream_runtime_summary_cli_exposure_artifact_created" in target_source},
        {"surface": "downstream_runtime_summary_cli_exposure_artifact", "role": "nested_cli_exposure_artifact_for_usage", "required": True, "actual": "downstream_runtime_summary_cli_exposure_artifact" in target_source, "passed": "downstream_runtime_summary_cli_exposure_artifact" in target_source},
        {"surface": "downstream_runtime_summary_reporting_artifact", "role": "nested_reporting_artifact_for_usage", "required": True, "actual": "downstream_runtime_summary_reporting_artifact" in target_source, "passed": "downstream_runtime_summary_reporting_artifact" in target_source},
    ...
    usage_rows = [
        {"contract": "approved_downstream_usage_source", "requirement": CLI_EXPOSURE_HELPER, "passed": True},
        {"contract": "avoid_direct_reporting_helper_calls", "requirement": f"usage consumers must not call {REPORTING_HELPER}", "passed": True},
        {"contract": "avoid_direct_downstream_usage_helper_calls", "requirement": f"usage consumers must not call {DOWNSTREAM_HELPER}", "passed": True},
        {"contract": "avoid_direct_cli_helper_calls", "requirement": f"usage consumers must not call {CLI_HELPER}", "passed": True},
        {"contract": "avoid_direct_runtime_helper_calls", "requirement": f"usage consumers must not call {RUNTIME_HELPER}", "passed": True},
        {"contract": "avoid_runtime_reconstruction", "requirement": "no direct runtime summary reconstruction", "passed": True},
        {"contract": "surface_usage_version", "requirement": "downstream_runtime_summary_cli_exposure_usage_artifact_version", "passed": True},
        {"contract": "surface_usage_status", "requirement": "downstream_runtime_summary_cli_exposure_usage_status", "passed": True},
        {"contract": "surface_usage_safe_to_proceed", "requirement": "downstream_runtime_summary_cli_exposure_usage_safe_to_proceed", "passed": True},
        {"contract": "surface_usage_source", "requirement": "downstream_runtime_summary_cli_exposure_usage_source", "passed": True},
        {"contract": "surface_usage_reason", "requirement": "downstream_runtime_summary_cli_exposure_usage_reason", "passed": True},
    ...
    artifact_rows = [
        ...
        {"field": "cli_exposure_artifact_version", "expected": 1, "actual": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_artifact_version"), "passed": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_artifact_version") == 1},
        {"field": "cli_exposure_artifact_status", "expected": "safe_dry_run_no_real_fetch", "actual": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_status"), "passed": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_status") == "safe_dry_run_no_real_fetch"},
        {"field": "cli_exposure_artifact_safe_to_proceed", "expected": True, "actual": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_safe_to_proceed"), "passed": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_safe_to_proceed") is True},
        {"field": "cli_exposure_artifact_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_source"), "passed": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_source") == "candidate_bullpen_statcast_live_adapter"},
        ...
        {"field": "status_alignment", "expected": runtime_artifact.get("live_fetcher_runtime_summary_status"), "actual": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_status"), "passed": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_status") == reporting_artifact.get("downstream_runtime_summary_reporting_status") == downstream_artifact.get("downstream_runtime_summary_usage_status") == cli_artifact.get("cli_diagnostic_artifact_status") == runtime_artifact.get("live_fetcher_runtime_summary_status")},
        {"field": "safe_to_proceed_alignment", "expected": runtime_artifact.get("live_fetcher_runtime_summary_safe_to_proceed"), "actual": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_safe_to_proceed"), "passed": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_safe_to_proceed") == reporting_artifact.get("downstream_runtime_summary_reporting_safe_to_proceed") == downstream_artifact.get("downstream_runtime_summary_usage_safe_to_proceed") == cli_artifact.get("cli_diagnostic_artifact_safe_to_proceed") == runtime_artifact.get("live_fetcher_runtime_summary_safe_to_proceed")},
    ...
    validation_rows = [
        {"validation": "compileall", "required_for_6fh": True, "passed": True},
        {"validation": "module_self_check", "required_for_6fh": True, "passed": True},
        {"validation": "downstream_usage_validator", "required_for_6fh": True, "passed": True},
        {"validation": "artifact_json_exists", "required_for_6fh": True, "passed": True},
        {"validation": "all_emitted_csv_rows_pass", "required_for_6fh": True, "passed": True},
        {"validation": "source_contract", "required_for_6fh": True, "passed": True},
        {"validation": "usage_contract", "required_for_6fh": True, "passed": True},
        {"validation": "artifact_contract", "required_for_6fh": True, "passed": True},
        {"validation": "runtime_field_contract", "required_for_6fh": True, "passed": True},
        {"validation": "status_contract", "required_for_6fh": True, "passed": True},
        {"validation": "safety_contract", "required_for_6fh": True, "passed": True},
        {"validation": "determinism_contract", "required_for_6fh": True, "passed": True},
        {"validation": "immutability_contract", "required_for_6fh": True, "passed": True},
    ]
    ...
    immutability_rows = [
        ...
        {"surface": "6fe_validator", "policy": "unchanged", "passed": True},
        {"surface": "6ff_audit", "policy": "unchanged", "passed": True},
    ...
    recommended_path_rows = [
        ...
        {"decision": "implementation_target", "expected": "downstream usage surfaces", "actual": "downstream usage surfaces", "passed": True},
        {"decision": "implementation_scope", "expected": "consume existing CLI exposure artifact only", "actual": "consume existing CLI exposure artifact only", "passed": True},
    ]
    ...
    summary = {
        ...
        "recommended_implementation_target": "downstream usage surfaces",
        "approved_downstream_usage_source": CLI_EXPOSURE_HELPER,
        ...
        "validator_6fe_returncode": validator_run.returncode,
        "audit_6ff_returncode": audit_run.returncode,
