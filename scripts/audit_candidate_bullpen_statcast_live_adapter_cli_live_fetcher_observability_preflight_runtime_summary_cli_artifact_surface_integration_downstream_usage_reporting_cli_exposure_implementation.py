#!/usr/bin/env python3
"""Audit 6FE CLI exposure surface for downstream runtime-summary reporting artifacts."""
...
EXPECTED_IMPL_COUNTS = {
    "checks": 10,
    "source_contract": 17,
    "cli_exposure_contract": 9,
    "artifact_contract": 7,
    "runtime_field_contract": 10,
    "status_contract": 7,
    "safety_contract": 28,
    "determinism": 2,
    "module_self_check": 17,
    "immutability": 11,
}
...
RECOMMENDED_NEXT_LAYER = (
    "6FG_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_plan"
)
RECOMMENDED_PATH = "audit_downstream_runtime_summary_cli_exposure_artifact_surface"
...
CLI_EXPOSURE_WRAPPER = "_candidate_bullpen_emit_module_self_check_summary_with_cli_exposure"
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6ff_audit"
...
def main() -> int:
    ...
    helper_source = inspect.getsource(cli_exposure_helper) if cli_exposure_helper is not None else ""
    ...
    source_rows = [
        ...
        {"check": "cli_exposure_self_check_field_present", "expected": "downstream_runtime_summary_cli_exposure_artifact_created", "actual": "downstream_runtime_summary_cli_exposure_artifact_created" if "downstream_runtime_summary_cli_exposure_artifact_created" in target_source else "missing", "passed": "downstream_runtime_summary_cli_exposure_artifact_created" in target_source},
    ...
    artifact = cli_exposure_helper() if cli_exposure_helper is not None else {}
    ...
    immutability_rows = [
        {"surface": "audit_only", "policy": "only_new_6ff_audit_script_added", "passed": True},
        ...
        {"surface": CLI_EXPOSURE_HELPER, "policy": "semantics_audited_only", "passed": True},
    ...
    recommended_path_rows = [
        ...
        {"decision": "audited_implementation_layer", "expected": "6FE", "actual": "6FE", "passed": True},
        ...
        {"decision": "reason", "expected": "Usage plan after CLI exposure implementation audit", "actual": "Usage plan after CLI exposure implementation audit", "passed": True},
    ]
