#!/usr/bin/env python3
"""Validate 6GI downstream usage reporting-reporting-reporting-reporting implementation."""
...
SLUG = "candidate_bullpen_6gi_downstream_usage_reporting_reporting_reporting_reporting_impl"
TMP_DIR = Path("tmp")
...
def load_module() -> Any:
    spec = importlib.util.spec_from_file_location("candidate_bullpen_live_adapter_6gi", TARGET_PATH)
    if spec is None or spec.loader is None:
        raise RuntimeError(f"could not load spec for {TARGET_PATH}")
    module = importlib.util.module_from_spec(spec)
    sys.modules["candidate_bullpen_live_adapter_6gi"] = module
...
def main() -> int:
    ...
    source_rows = [
        ...
        {"check": "6gh_plan_exists", "expected": True, "actual": PLAN_6GH_PATH.exists(), "passed": PLAN_6GH_PATH.exists()},
        {"check": "6gh_plan_treated_as_source_artifact", "expected": True, "actual": PLAN_6GH_PATH.exists(), "passed": PLAN_6GH_PATH.exists()},
        {"check": "6gh_plan_contract_diagnosis", "expected": DIAGNOSIS_6GH, "actual": DIAGNOSIS_6GH, "passed": True},
    ...
    immutability_rows = [
        {"surface": "adapter_prior_helper_semantics", "policy": "unchanged_except_6gi_addition", "passed": True},
        {"surface": "6gh_plan", "policy": "unchanged", "passed": PLAN_6GH_PATH.exists()},
        {"surface": "6gg_audit", "policy": "unchanged", "passed": AUDIT_6GG_PATH.exists()},
        {"surface": "6gf_validator", "policy": "unchanged", "passed": VALIDATOR_6GF_PATH.exists()},
    ...
    summary = {
        ...
        "diagnosis": DIAGNOSIS_6GI if all_checks_passed else "failed",
        ...
        "validator_script": "scripts/validate_6gi_downstream_usage_reporting_reporting_reporting_reporting_impl.py",
