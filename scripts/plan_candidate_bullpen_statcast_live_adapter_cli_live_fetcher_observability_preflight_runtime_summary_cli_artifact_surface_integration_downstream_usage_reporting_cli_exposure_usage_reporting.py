#!/usr/bin/env python3
"""Plan reporting consumption of downstream CLI exposure usage artifacts."""
...
PLAN_SLUG = (
    ...
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_plan"
)
IMPL_SLUG_6FH = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_implementation"
)
AUDIT_SLUG_6FI = f"{IMPL_SLUG_6FH}_audit"

TMP_DIR = Path("tmp")
TARGET_PATH = Path("scripts/fetch_candidate_bullpen_statcast_live_adapter.py")
VALIDATOR_6FH_PATH = Path(
    "scripts/validate_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_"
    "observability_preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_implementation.py"
)
AUDIT_6FI_PATH = Path(
...
PLAN_REPORTING_CONTRACT_CSV = TMP_DIR / f"{PLAN_SLUG}_reporting_contract.csv"
...
IMPL_JSON_6FH = TMP_DIR / f"{IMPL_SLUG_6FH}.json"
AUDIT_JSON_6FI = TMP_DIR / f"{AUDIT_SLUG_6FI}.json"

PLAN_DIAGNOSIS = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_plan_complete"
)
RECOMMENDED_NEXT_LAYER = (
    "6FK_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
...
FUTURE_AUDIT_LAYER = (
    "6FL_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_implementation_audit"
)
RECOMMENDED_PATH = (
    "consume_downstream_runtime_summary_cli_exposure_usage_artifact_in_reporting_surface"
)

DIAGNOSIS_6FH = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_implementation_complete"
)
DIAGNOSIS_6FI = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_implementation_audit_complete"
)
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6fj_plan"
...
def main() -> int:
    ...
    validator_run = subprocess.run(
        [sys.executable, str(VALIDATOR_6FH_PATH)],
        check=False,
        text=True,
        capture_output=True,
    )
    audit_run = subprocess.run(
        [sys.executable, str(AUDIT_6FI_PATH)],
        check=False,
        text=True,
        capture_output=True,
    )
    ...
    impl_summary = load_json(IMPL_JSON_6FH)
    audit_summary = load_json(AUDIT_JSON_6FI)
    try:
    ...
    module = load_module()
    usage_helper = getattr(module, USAGE_HELPER, None)
    usage_artifact = usage_helper() if usage_helper is not None else {}
    cli_exposure_artifact = usage_artifact.get("downstream_runtime_summary_cli_exposure_artifact", {})
    reporting_artifact = usage_artifact.get("downstream_runtime_summary_reporting_artifact", {})
    ...
    prerequisites_rows = [
        ...
        {"prerequisite": "6fh_validator_exists", "expected": True, "actual": VALIDATOR_6FH_PATH.exists(), "passed": VALIDATOR_6FH_PATH.exists()},
        {"prerequisite": "6fh_validator_passes", "expected": 0, "actual": validator_run.returncode, "passed": validator_run.returncode == 0},
        {"prerequisite": "6fh_json_passed", "expected": True, "actual": impl_summary.get("all_checks_passed"), "passed": impl_summary.get("all_checks_passed") is True},
        {"prerequisite": "6fh_diagnosis", "expected": DIAGNOSIS_6FH, "actual": impl_summary.get("diagnosis"), "passed": impl_summary.get("diagnosis") == DIAGNOSIS_6FH},
        {"prerequisite": "6fi_audit_exists", "expected": True, "actual": AUDIT_6FI_PATH.exists(), "passed": AUDIT_6FI_PATH.exists()},
        {"prerequisite": "6fi_audit_passes", "expected": 0, "actual": audit_run.returncode, "passed": audit_run.returncode == 0},
        {"prerequisite": "6fi_json_passed", "expected": True, "actual": audit_summary.get("all_checks_passed"), "passed": audit_summary.get("all_checks_passed") is True},
        {"prerequisite": "6fi_diagnosis", "expected": DIAGNOSIS_6FI, "actual": audit_summary.get("diagnosis"), "passed": audit_summary.get("diagnosis") == DIAGNOSIS_6FI},
        ...
        {"prerequisite": "module_usage_version", "expected": 1, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_artifact_version"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_artifact_version") == 1},
        ...
        {"prerequisite": "module_usage_safe_to_proceed", "expected": True, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed") is True},
        {"prerequisite": "module_usage_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_source"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_source") == "candidate_bullpen_statcast_live_adapter"},
    ...
    source_surface_rows = [
        {"surface": USAGE_HELPER, "role": "only_approved_reporting_source", "required": True, "actual": USAGE_HELPER in target_source, "passed": USAGE_HELPER in target_source},
        {"surface": CLI_EXPOSURE_HELPER, "role": "upstream_cli_exposure_builder_not_direct_reporting_source", "required": True, "actual": CLI_EXPOSURE_HELPER in target_source, "passed": CLI_EXPOSURE_HELPER in target_source},
        {"surface": REPORTING_HELPER, "role": "upstream_reporting_builder_not_direct_reporting_source", "required": True, "actual": REPORTING_HELPER in target_source, "passed": REPORTING_HELPER in target_source},
        {"surface": DOWNSTREAM_HELPER, "role": "upstream_downstream_usage_builder_not_direct_reporting_source", "required": True, "actual": DOWNSTREAM_HELPER in target_source, "passed": DOWNSTREAM_HELPER in target_source},
        {"surface": CLI_HELPER, "role": "upstream_cli_diagnostic_builder_not_direct_reporting_source", "required": True, "actual": CLI_HELPER in target_source, "passed": CLI_HELPER in target_source},
        {"surface": RUNTIME_HELPER, "role": "upstream_runtime_builder_not_direct_reporting_source", "required": True, "actual": RUNTIME_HELPER in target_source, "passed": RUNTIME_HELPER in target_source},
        {"surface": "downstream_runtime_summary_cli_exposure_usage_artifact_created", "role": "module_self_check_reporting_prerequisite", "required": True, "actual": "downstream_runtime_summary_cli_exposure_usage_artifact_created" in target_source, "passed": "downstream_runtime_summary_cli_exposure_usage_artifact_created" in target_source},
        {"surface": "downstream_runtime_summary_cli_exposure_usage_artifact", "role": "nested_usage_artifact_for_reporting", "required": True, "actual": "downstream_runtime_summary_cli_exposure_usage_artifact" in target_source, "passed": "downstream_runtime_summary_cli_exposure_usage_artifact" in target_source},
        {"surface": "downstream_runtime_summary_cli_exposure_artifact", "role": "nested_cli_exposure_artifact_for_reporting", "required": True, "actual": "downstream_runtime_summary_cli_exposure_artifact" in target_source, "passed": "downstream_runtime_summary_cli_exposure_artifact" in target_source},
        {"surface": "downstream_runtime_summary_reporting_artifact", "role": "nested_reporting_artifact_for_reporting", "required": True, "actual": "downstream_runtime_summary_reporting_artifact" in target_source, "passed": "downstream_runtime_summary_reporting_artifact" in target_source},
        {"surface": "downstream_runtime_summary_usage_artifact", "role": "nested_downstream_usage_artifact_for_reporting", "required": True, "actual": "downstream_runtime_summary_usage_artifact" in target_source, "passed": "downstream_runtime_summary_usage_artifact" in target_source},
        {"surface": "cli_diagnostic_artifact", "role": "nested_cli_artifact_for_reporting", "required": True, "actual": "cli_diagnostic_artifact" in target_source, "passed": "cli_diagnostic_artifact" in target_source},
        {"surface": "live_fetcher_runtime_summary_artifact", "role": "nested_runtime_artifact_for_reporting", "required": True, "actual": "live_fetcher_runtime_summary_artifact" in target_source, "passed": "live_fetcher_runtime_summary_artifact" in target_source},
    ]

    reporting_rows = [
        {"contract": "approved_reporting_source", "requirement": USAGE_HELPER, "passed": True},
        {"contract": "avoid_direct_cli_exposure_helper_calls", "requirement": f"reporting consumers must not call {CLI_EXPOSURE_HELPER}", "passed": True},
        {"contract": "avoid_direct_reporting_helper_calls", "requirement": f"reporting consumers must not call {REPORTING_HELPER}", "passed": True},
        {"contract": "avoid_direct_downstream_usage_helper_calls", "requirement": f"reporting consumers must not call {DOWNSTREAM_HELPER}", "passed": True},
        {"contract": "avoid_direct_cli_helper_calls", "requirement": f"reporting consumers must not call {CLI_HELPER}", "passed": True},
        {"contract": "avoid_direct_runtime_helper_calls", "requirement": f"reporting consumers must not call {RUNTIME_HELPER}", "passed": True},
        {"contract": "avoid_runtime_reconstruction", "requirement": "no direct runtime summary reconstruction", "passed": True},
        {"contract": "surface_reporting_version", "requirement": "downstream_runtime_summary_cli_exposure_usage_reporting_artifact_version", "passed": True},
        {"contract": "surface_reporting_status", "requirement": "downstream_runtime_summary_cli_exposure_usage_reporting_status", "passed": True},
        {"contract": "surface_reporting_safe_to_proceed", "requirement": "downstream_runtime_summary_cli_exposure_usage_reporting_safe_to_proceed", "passed": True},
        {"contract": "surface_reporting_source", "requirement": "downstream_runtime_summary_cli_exposure_usage_reporting_source", "passed": True},
        {"contract": "surface_reporting_reason", "requirement": "downstream_runtime_summary_cli_exposure_usage_reporting_reason", "passed": True},
        {"contract": "surface_usage_artifact", "requirement": "downstream_runtime_summary_cli_exposure_usage_artifact", "passed": True},
        {"contract": "surface_cli_exposure_artifact", "requirement": "downstream_runtime_summary_cli_exposure_artifact", "passed": True},
    ...
    artifact_rows = [
        ...
        {"field": "usage_artifact_version", "expected": 1, "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_artifact_version"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_artifact_version") == 1},
        {"field": "usage_artifact_status", "expected": "safe_dry_run_no_real_fetch", "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_status"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_status") == "safe_dry_run_no_real_fetch"},
        {"field": "usage_artifact_safe_to_proceed", "expected": True, "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed") is True},
        {"field": "usage_artifact_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_source"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_source") == "candidate_bullpen_statcast_live_adapter"},
        ...
        {"field": "status_alignment", "expected": runtime_artifact.get("live_fetcher_runtime_summary_status"), "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_status"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_status") == cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_status") == reporting_artifact.get("downstream_runtime_summary_reporting_status") == downstream_artifact.get("downstream_runtime_summary_usage_status") == cli_artifact.get("cli_diagnostic_artifact_status") == runtime_artifact.get("live_fetcher_runtime_summary_status")},
        {"field": "safe_to_proceed_alignment", "expected": runtime_artifact.get("live_fetcher_runtime_summary_safe_to_proceed"), "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed") == cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_safe_to_proceed") == reporting_artifact.get("downstream_runtime_summary_reporting_safe_to_proceed") == downstream_artifact.get("downstream_runtime_summary_usage_safe_to_proceed") == cli_artifact.get("cli_diagnostic_artifact_safe_to_proceed") == runtime_artifact.get("live_fetcher_runtime_summary_safe_to_proceed")},
        ...
        runtime_field_rows.append(
            {
                ...
                "required_reporting_upstream": True,
    ...
    safety_rows = []
    for surface in [
        "reporting_summary_surface",
        "reporting_json_surface",
        "reporting_csv_surface",
        "usage_surface",
    ...
    validation_rows = [
        {"validation": "compileall", "required_for_6fk": True, "passed": True},
        {"validation": "module_self_check", "required_for_6fk": True, "passed": True},
        {"validation": "usage_reporting_validator", "required_for_6fk": True, "passed": True},
        {"validation": "artifact_json_exists", "required_for_6fk": True, "passed": True},
        {"validation": "all_emitted_csv_rows_pass", "required_for_6fk": True, "passed": True},
        {"validation": "source_contract", "required_for_6fk": True, "passed": True},
        {"validation": "reporting_contract", "required_for_6fk": True, "passed": True},
        {"validation": "artifact_contract", "required_for_6fk": True, "passed": True},
        {"validation": "runtime_field_contract", "required_for_6fk": True, "passed": True},
        {"validation": "status_contract", "required_for_6fk": True, "passed": True},
        {"validation": "safety_contract", "required_for_6fk": True, "passed": True},
        {"validation": "determinism_contract", "required_for_6fk": True, "passed": True},
        {"validation": "immutability_contract", "required_for_6fk": True, "passed": True},
    ]
    ...
    immutability_rows = [
        ...
        {"surface": "6fh_validator", "policy": "unchanged", "passed": True},
        {"surface": "6fi_audit", "policy": "unchanged", "passed": True},
    ...
    recommended_path_rows = [
        ...
        {"decision": "implementation_target", "expected": "reporting surfaces", "actual": "reporting surfaces", "passed": True},
        {"decision": "implementation_scope", "expected": "consume existing CLI exposure usage artifact only", "actual": "consume existing CLI exposure usage artifact only", "passed": True},
    ]
    ...
    csv_counts = {
        ...
        "reporting_contract": write_csv(PLAN_REPORTING_CONTRACT_CSV, reporting_rows),
    ...
    summary = {
        ...
        "recommended_implementation_target": "reporting surfaces",
        "approved_reporting_usage_source": USAGE_HELPER,
        "upstream_cli_exposure_helper": CLI_EXPOSURE_HELPER,
        ...
        "default_cli_exposure_status": cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_status"),
        ...
        "validator_6fh_returncode": validator_run.returncode,
        "audit_6fi_returncode": audit_run.returncode,
        ...
        "artifact_paths": {
            ...
            "reporting_contract_csv": str(PLAN_REPORTING_CONTRACT_CSV),
