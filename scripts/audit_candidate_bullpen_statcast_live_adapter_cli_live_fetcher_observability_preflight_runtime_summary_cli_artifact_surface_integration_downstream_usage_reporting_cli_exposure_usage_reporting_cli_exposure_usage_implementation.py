#!/usr/bin/env python3
"""Audit 6FQ usage-facing surface for usage-reporting CLI exposure artifacts."""
...
RECOMMENDED_NEXT_LAYER = (
    "6FS_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
...
RECOMMENDED_PATH = (
    "audit_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_surface"
)
...
USAGE_WRAPPER = "_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage"
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6fr_audit"
...
def main() -> int:
    ...
    source_rows = [
        ...
        {"check": "usage_helper_present", "expected": USAGE_HELPER_NEW, "actual": USAGE_HELPER_NEW if USAGE_HELPER_NEW in target_source else "missing", "passed": USAGE_HELPER_NEW in target_source},
        {"check": "approved_usage_source_present", "expected": APPROVED_USAGE_SOURCE, "actual": APPROVED_USAGE_SOURCE if APPROVED_USAGE_SOURCE in target_source else "missing", "passed": APPROVED_USAGE_SOURCE in target_source},
        ...
        {"check": "usage_helper_upstream_present", "expected": USAGE_HELPER, "actual": USAGE_HELPER if USAGE_HELPER in target_source else "missing", "passed": USAGE_HELPER in target_source},
        ...
        {"check": "usage_self_check_created_field_present", "expected": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_created", "actual": "present" if "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_created" in target_source else "missing", "passed": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_created" in target_source},
        {"check": "usage_self_check_status_field_present", "expected": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status", "actual": "present" if "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status" in target_source else "missing", "passed": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status" in target_source},
        {"check": "usage_artifact_surface_present", "expected": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact", "actual": "present" if "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact" in target_source else "missing", "passed": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact" in target_source},
        {"check": "cli_exposure_artifact_surface_present", "expected": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact", "actual": "present" if "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact" in target_source else "missing", "passed": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact" in target_source},
        {"check": "reporting_artifact_surface_present", "expected": "downstream_runtime_summary_cli_exposure_usage_reporting_artifact", "actual": "present" if "downstream_runtime_summary_cli_exposure_usage_reporting_artifact" in target_source else "missing", "passed": "downstream_runtime_summary_cli_exposure_usage_reporting_artifact" in target_source},
        {"check": "usage_artifact_nested_surface_present", "expected": "downstream_runtime_summary_cli_exposure_usage_artifact", "actual": "present" if "downstream_runtime_summary_cli_exposure_usage_artifact" in target_source else "missing", "passed": "downstream_runtime_summary_cli_exposure_usage_artifact" in target_source},
        {"check": "prior_cli_exposure_artifact_surface_present", "expected": "downstream_runtime_summary_cli_exposure_artifact", "actual": "present" if "downstream_runtime_summary_cli_exposure_artifact" in target_source else "missing", "passed": "downstream_runtime_summary_cli_exposure_artifact" in target_source},
        {"check": "upstream_reporting_artifact_surface_present", "expected": "downstream_runtime_summary_reporting_artifact", "actual": "present" if "downstream_runtime_summary_reporting_artifact" in target_source else "missing", "passed": "downstream_runtime_summary_reporting_artifact" in target_source},
        {"check": "downstream_usage_artifact_surface_present", "expected": "downstream_runtime_summary_usage_artifact", "actual": "present" if "downstream_runtime_summary_usage_artifact" in target_source else "missing", "passed": "downstream_runtime_summary_usage_artifact" in target_source},
        {"check": "runtime_artifact_surface_present", "expected": "live_fetcher_runtime_summary_artifact", "actual": "present" if "live_fetcher_runtime_summary_artifact" in target_source else "missing", "passed": "live_fetcher_runtime_summary_artifact" in target_source},
        {"check": "cli_artifact_surface_present", "expected": "cli_diagnostic_artifact", "actual": "present" if "cli_diagnostic_artifact" in target_source else "missing", "passed": "cli_diagnostic_artifact" in target_source},
    ...
    upstream_usage_artifact = artifact.get("downstream_runtime_summary_cli_exposure_usage_artifact", {})
    ...
    usage_rows = [
        {"contract": "usage_artifact_is_dict", "expected": True, "actual": isinstance(artifact, dict), "passed": isinstance(artifact, dict)},
        ...
        {"contract": "upstream_usage_artifact_nested", "expected": True, "actual": isinstance(upstream_usage_artifact, dict), "passed": isinstance(upstream_usage_artifact, dict)},
        ...
        runtime_rows.append(
            {
                ...
                "upstream_usage_present": field in upstream_usage_artifact,
                ...
                "upstream_usage_value": upstream_usage_artifact.get(field),
                ...
                and field in upstream_usage_artifact
                ...
                == upstream_usage_artifact.get(field)
            ...
            safety_rows.append(
                {
                    ...
                    "upstream_usage_actual": scenario_usage.get(safety_key),
    ...
    immutability_rows = [
        {"surface": "audit_only", "policy": "only_new_6fr_audit_script_added", "passed": True},
        ...
        {"surface": USAGE_HELPER_NEW, "policy": "semantics_audited_only", "passed": True},
    ...
    recommended_path_rows = [
        ...
        {"decision": "audited_implementation_layer", "expected": "6FQ", "actual": "6FQ", "passed": True},
        ...
        {"decision": "reason", "expected": "downstream plan after usage-facing implementation audit", "actual": "downstream plan after usage-facing implementation audit", "passed": True},
    ]
    ...
    checks = [
        ...
        {"check": "validator_executed", "passed": validator_run.returncode == 0, "detail": f"returncode={validator_run.returncode}"},
        {
            ...
            and impl_summary.get("default_upstream_usage_status") == "safe_dry_run_no_real_fetch"
    ...
    summary = {
        ...
        "default_upstream_usage_status": upstream_usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_status"),
