#!/usr/bin/env python3
"""Plan downstream-facing consumption of usage-reporting CLI exposure usage artifacts."""
...
PLAN_SLUG = (
    ...
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_downstream_plan"
)
IMPL_SLUG_6FQ = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
...
AUDIT_SLUG_6FR = f"{IMPL_SLUG_6FQ}_audit"

TMP_DIR = Path("tmp")
TARGET_PATH = Path("scripts/fetch_candidate_bullpen_statcast_live_adapter.py")
VALIDATOR_6FQ_PATH = Path(
    "scripts/validate_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_"
    "observability_preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_implementation.py"
)
AUDIT_6FR_PATH = Path(
...
PLAN_DOWNSTREAM_CONTRACT_CSV = TMP_DIR / f"{PLAN_SLUG}_downstream_contract.csv"
...
IMPL_JSON_6FQ = TMP_DIR / f"{IMPL_SLUG_6FQ}.json"
AUDIT_JSON_6FR = TMP_DIR / f"{AUDIT_SLUG_6FR}.json"

PLAN_DIAGNOSIS = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_downstream_plan_complete"
)
RECOMMENDED_NEXT_LAYER = (
    "6FT_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_downstream_implementation"
)
FUTURE_AUDIT_LAYER = (
    "6FU_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_downstream_implementation_audit"
)
RECOMMENDED_PATH = (
    "consume_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_in_downstream_surface"
)
...
DIAGNOSIS_6FR = (
    "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_cli_exposure_usage_reporting_cli_exposure_usage_implementation_audit_complete"
)
...
FUTURE_DOWNSTREAM_HELPER = "_candidate_bullpen_build_downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact"
FUTURE_WRAPPER = "_candidate_bullpen_emit_module_self_check_summary_with_usage_reporting_cli_exposure_usage_downstream"
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6fs_plan"
...
def main() -> int:
    ...
    validator_run = subprocess.run(
        [sys.executable, str(VALIDATOR_6FQ_PATH)],
        check=False,
        text=True,
        capture_output=True,
    )
    audit_run = subprocess.run(
        [sys.executable, str(AUDIT_6FR_PATH)],
        check=False,
        text=True,
        capture_output=True,
    )
    ...
    impl_summary = load_json(IMPL_JSON_6FQ)
    audit_summary = load_json(AUDIT_JSON_6FR)
    try:
    ...
    module = load_module()
    usage_helper = getattr(module, APPROVED_DOWNSTREAM_SOURCE, None)
    usage_artifact = usage_helper() if usage_helper is not None else {}
    cli_exposure_artifact = usage_artifact.get(
        "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact", {}
    )
    reporting_artifact = usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_artifact", {})
    prior_usage_artifact = usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_artifact", {})
    prior_cli_exposure_artifact = usage_artifact.get("downstream_runtime_summary_cli_exposure_artifact", {})
    upstream_reporting_artifact = usage_artifact.get("downstream_runtime_summary_reporting_artifact", {})
    downstream_artifact = usage_artifact.get("downstream_runtime_summary_usage_artifact", {})
    cli_artifact = usage_artifact.get("cli_diagnostic_artifact", {})
    runtime_artifact = usage_artifact.get("live_fetcher_runtime_summary_artifact", {})

    prerequisites_rows = [
        {"prerequisite": "compileall_passes", "expected": 0, "actual": compile_run.returncode, "passed": compile_run.returncode == 0},
        {"prerequisite": "6fq_validator_exists", "expected": True, "actual": VALIDATOR_6FQ_PATH.exists(), "passed": VALIDATOR_6FQ_PATH.exists()},
        {"prerequisite": "6fq_validator_passes", "expected": 0, "actual": validator_run.returncode, "passed": validator_run.returncode == 0},
        {"prerequisite": "6fq_json_passed", "expected": True, "actual": impl_summary.get("all_checks_passed"), "passed": impl_summary.get("all_checks_passed") is True},
        {"prerequisite": "6fq_diagnosis", "expected": DIAGNOSIS_6FQ, "actual": impl_summary.get("diagnosis"), "passed": impl_summary.get("diagnosis") == DIAGNOSIS_6FQ},
        {"prerequisite": "6fr_audit_exists", "expected": True, "actual": AUDIT_6FR_PATH.exists(), "passed": AUDIT_6FR_PATH.exists()},
        {"prerequisite": "6fr_audit_passes", "expected": 0, "actual": audit_run.returncode, "passed": audit_run.returncode == 0},
        {"prerequisite": "6fr_json_passed", "expected": True, "actual": audit_summary.get("all_checks_passed"), "passed": audit_summary.get("all_checks_passed") is True},
        {"prerequisite": "6fr_diagnosis", "expected": DIAGNOSIS_6FR, "actual": audit_summary.get("diagnosis"), "passed": audit_summary.get("diagnosis") == DIAGNOSIS_6FR},
        {"prerequisite": "module_self_check_passes", "expected": 0, "actual": module_run.returncode, "passed": module_run.returncode == 0},
        {"prerequisite": "module_usage_created", "expected": True, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_created"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_created") is True},
        {"prerequisite": "module_usage_version", "expected": 1, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_version"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_version") == 1},
        {"prerequisite": "module_usage_status", "expected": "safe_dry_run_no_real_fetch", "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status") == "safe_dry_run_no_real_fetch"},
        {"prerequisite": "module_usage_safe_to_proceed", "expected": True, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_safe_to_proceed"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_safe_to_proceed") is True},
        {"prerequisite": "module_usage_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_source"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_source") == "candidate_bullpen_statcast_live_adapter"},
        {"prerequisite": "module_cli_exposure_created", "expected": True, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact_created"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact_created") is True},
        {"prerequisite": "module_cli_exposure_status", "expected": "safe_dry_run_no_real_fetch", "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_status"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_status") == "safe_dry_run_no_real_fetch"},
        ...
        {"prerequisite": "module_prior_usage_created", "expected": True, "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_artifact_created"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_artifact_created") is True},
        {"prerequisite": "module_prior_usage_status", "expected": "safe_dry_run_no_real_fetch", "actual": module_summary.get("downstream_runtime_summary_cli_exposure_usage_status"), "passed": module_summary.get("downstream_runtime_summary_cli_exposure_usage_status") == "safe_dry_run_no_real_fetch"},
    ...
    source_surface_rows = [
        {"surface": APPROVED_DOWNSTREAM_SOURCE, "role": "only_approved_downstream_source", "required": True, "actual": APPROVED_DOWNSTREAM_SOURCE in target_source, "passed": APPROVED_DOWNSTREAM_SOURCE in target_source},
        {"surface": APPROVED_USAGE_SOURCE, "role": "approved_usage_source_not_direct_downstream_source", "required": True, "actual": APPROVED_USAGE_SOURCE in target_source, "passed": APPROVED_USAGE_SOURCE in target_source},
        {"surface": REPORTING_HELPER, "role": "upstream_reporting_builder_not_direct_downstream_source", "required": True, "actual": REPORTING_HELPER in target_source, "passed": REPORTING_HELPER in target_source},
        {"surface": PRIOR_USAGE_HELPER, "role": "prior_usage_builder_not_direct_downstream_source", "required": True, "actual": PRIOR_USAGE_HELPER in target_source, "passed": PRIOR_USAGE_HELPER in target_source},
        {"surface": PRIOR_CLI_EXPOSURE_HELPER, "role": "prior_cli_exposure_builder_not_direct_downstream_source", "required": True, "actual": PRIOR_CLI_EXPOSURE_HELPER in target_source, "passed": PRIOR_CLI_EXPOSURE_HELPER in target_source},
        {"surface": UPSTREAM_REPORTING_HELPER, "role": "upstream_reporting_builder_not_direct_downstream_source", "required": True, "actual": UPSTREAM_REPORTING_HELPER in target_source, "passed": UPSTREAM_REPORTING_HELPER in target_source},
        {"surface": DOWNSTREAM_HELPER, "role": "downstream_usage_builder_not_direct_downstream_source", "required": True, "actual": DOWNSTREAM_HELPER in target_source, "passed": DOWNSTREAM_HELPER in target_source},
        {"surface": CLI_HELPER, "role": "cli_diagnostic_builder_not_direct_downstream_source", "required": True, "actual": CLI_HELPER in target_source, "passed": CLI_HELPER in target_source},
        {"surface": RUNTIME_HELPER, "role": "runtime_builder_not_direct_downstream_source", "required": True, "actual": RUNTIME_HELPER in target_source, "passed": RUNTIME_HELPER in target_source},
        {"surface": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_created", "role": "module_self_check_downstream_prerequisite", "required": True, "actual": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_created" in target_source, "passed": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_created" in target_source},
        {"surface": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact", "role": "nested_usage_artifact_for_downstream", "required": True, "actual": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact" in target_source, "passed": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact" in target_source},
        {"surface": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact", "role": "nested_cli_exposure_artifact_for_downstream", "required": True, "actual": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact" in target_source, "passed": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_artifact" in target_source},
        {"surface": "downstream_runtime_summary_cli_exposure_usage_reporting_artifact", "role": "nested_reporting_artifact_for_downstream", "required": True, "actual": "downstream_runtime_summary_cli_exposure_usage_reporting_artifact" in target_source, "passed": "downstream_runtime_summary_cli_exposure_usage_reporting_artifact" in target_source},
        {"surface": "downstream_runtime_summary_cli_exposure_usage_artifact", "role": "nested_prior_usage_artifact_for_downstream", "required": True, "actual": "downstream_runtime_summary_cli_exposure_usage_artifact" in target_source, "passed": "downstream_runtime_summary_cli_exposure_usage_artifact" in target_source},
        {"surface": "downstream_runtime_summary_cli_exposure_artifact", "role": "nested_prior_cli_exposure_artifact_for_downstream", "required": True, "actual": "downstream_runtime_summary_cli_exposure_artifact" in target_source, "passed": "downstream_runtime_summary_cli_exposure_artifact" in target_source},
        {"surface": "downstream_runtime_summary_reporting_artifact", "role": "nested_upstream_reporting_artifact_for_downstream", "required": True, "actual": "downstream_runtime_summary_reporting_artifact" in target_source, "passed": "downstream_runtime_summary_reporting_artifact" in target_source},
        {"surface": "downstream_runtime_summary_usage_artifact", "role": "nested_downstream_usage_artifact_for_downstream", "required": True, "actual": "downstream_runtime_summary_usage_artifact" in target_source, "passed": "downstream_runtime_summary_usage_artifact" in target_source},
        {"surface": "cli_diagnostic_artifact", "role": "nested_cli_artifact_for_downstream", "required": True, "actual": "cli_diagnostic_artifact" in target_source, "passed": "cli_diagnostic_artifact" in target_source},
        {"surface": "live_fetcher_runtime_summary_artifact", "role": "nested_runtime_artifact_for_downstream", "required": True, "actual": "live_fetcher_runtime_summary_artifact" in target_source, "passed": "live_fetcher_runtime_summary_artifact" in target_source},
    ]

    downstream_rows = [
        {"contract": "approved_downstream_source", "requirement": APPROVED_DOWNSTREAM_SOURCE, "passed": True},
        {"contract": "approved_usage_source", "requirement": APPROVED_USAGE_SOURCE, "passed": True},
        {"contract": "future_downstream_helper", "requirement": FUTURE_DOWNSTREAM_HELPER, "passed": True},
        {"contract": "future_module_self_check_wrapper", "requirement": FUTURE_WRAPPER, "passed": True},
        {"contract": "avoid_direct_usage_source_calls", "requirement": f"downstream helper must not call {APPROVED_USAGE_SOURCE}", "passed": True},
        {"contract": "avoid_direct_reporting_helper_calls", "requirement": f"downstream helper must not call {REPORTING_HELPER}", "passed": True},
        {"contract": "avoid_direct_prior_usage_helper_calls", "requirement": f"downstream helper must not call {PRIOR_USAGE_HELPER}", "passed": True},
        {"contract": "avoid_direct_prior_cli_exposure_helper_calls", "requirement": f"downstream helper must not call {PRIOR_CLI_EXPOSURE_HELPER}", "passed": True},
        {"contract": "avoid_direct_upstream_reporting_helper_calls", "requirement": f"downstream helper must not call {UPSTREAM_REPORTING_HELPER}", "passed": True},
        {"contract": "avoid_direct_downstream_usage_helper_calls", "requirement": f"downstream helper must not call {DOWNSTREAM_HELPER}", "passed": True},
        {"contract": "avoid_direct_cli_helper_calls", "requirement": f"downstream helper must not call {CLI_HELPER}", "passed": True},
        {"contract": "avoid_direct_runtime_helper_calls", "requirement": f"downstream helper must not call {RUNTIME_HELPER}", "passed": True},
        {"contract": "avoid_runtime_reconstruction", "requirement": "no direct runtime summary reconstruction", "passed": True},
        {"contract": "surface_downstream_version", "requirement": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_artifact_version", "passed": True},
        {"contract": "surface_downstream_status", "requirement": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_status", "passed": True},
        {"contract": "surface_downstream_safe_to_proceed", "requirement": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_safe_to_proceed", "passed": True},
        {"contract": "surface_downstream_source", "requirement": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_source", "passed": True},
        {"contract": "surface_downstream_reason", "requirement": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_downstream_reason", "passed": True},
        {"contract": "surface_usage_artifact", "requirement": "downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact", "passed": True},
        ...
        {"contract": "surface_prior_usage_artifact", "requirement": "downstream_runtime_summary_cli_exposure_usage_artifact", "passed": True},
    ...
    artifact_rows = [
        {"field": "usage_artifact_is_dict", "expected": True, "actual": isinstance(usage_artifact, dict), "passed": isinstance(usage_artifact, dict)},
        {"field": "usage_artifact_version", "expected": 1, "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_version"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_artifact_version") == 1},
        {"field": "usage_artifact_status", "expected": "safe_dry_run_no_real_fetch", "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status") == "safe_dry_run_no_real_fetch"},
        {"field": "usage_artifact_safe_to_proceed", "expected": True, "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_safe_to_proceed"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_safe_to_proceed") is True},
        {"field": "usage_artifact_source", "expected": "candidate_bullpen_statcast_live_adapter", "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_source"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_source") == "candidate_bullpen_statcast_live_adapter"},
        {"field": "nested_cli_exposure_artifact", "expected": True, "actual": isinstance(cli_exposure_artifact, dict), "passed": isinstance(cli_exposure_artifact, dict)},
        ...
        {"field": "nested_prior_usage_artifact", "expected": True, "actual": isinstance(prior_usage_artifact, dict), "passed": isinstance(prior_usage_artifact, dict)},
        ...
        {"field": "status_alignment", "expected": runtime_artifact.get("live_fetcher_runtime_summary_status"), "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_status") == cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_status") == reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_status") == prior_usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_status") == prior_cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_status") == upstream_reporting_artifact.get("downstream_runtime_summary_reporting_status") == downstream_artifact.get("downstream_runtime_summary_usage_status") == cli_artifact.get("cli_diagnostic_artifact_status") == runtime_artifact.get("live_fetcher_runtime_summary_status")},
        {"field": "safe_to_proceed_alignment", "expected": runtime_artifact.get("live_fetcher_runtime_summary_safe_to_proceed"), "actual": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_safe_to_proceed"), "passed": usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_usage_safe_to_proceed") == cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_cli_exposure_safe_to_proceed") == reporting_artifact.get("downstream_runtime_summary_cli_exposure_usage_reporting_safe_to_proceed") == prior_usage_artifact.get("downstream_runtime_summary_cli_exposure_usage_safe_to_proceed") == prior_cli_exposure_artifact.get("downstream_runtime_summary_cli_exposure_safe_to_proceed") == upstream_reporting_artifact.get("downstream_runtime_summary_reporting_safe_to_proceed") == downstream_artifact.get("downstream_runtime_summary_usage_safe_to_proceed") == cli_artifact.get("cli_diagnostic_artifact_safe_to_proceed") == runtime_artifact.get("live_fetcher_runtime_summary_safe_to_proceed")},
        {"field": "runtime_field_version", "expected": 1, "actual": usage_artifact.get("live_fetcher_runtime_summary_field_version"), "passed": usage_artifact.get("live_fetcher_runtime_summary_field_version") == 1},
    ]
        ...
        runtime_field_rows.append(
            {
                ...
                "downstream_usage_present": field in downstream_artifact,
                ...
                "downstream_usage_value": downstream_artifact.get(field),
                "cli_value": cli_artifact.get(field),
                "runtime_value": runtime_artifact.get(field),
                "passed": field in usage_artifact
    ...
    for surface in [
        "downstream_surface",
        "downstream_json_surface",
        "downstream_summary_surface",
        "usage_surface",
    ...
    validation_rows = [
        {"validation": "compileall", "required_for_6ft": True, "passed": True},
        {"validation": "module_self_check", "required_for_6ft": True, "passed": True},
        {"validation": "downstream_facing_validator", "required_for_6ft": True, "passed": True},
        {"validation": "artifact_json_exists", "required_for_6ft": True, "passed": True},
        {"validation": "all_emitted_csv_rows_pass", "required_for_6ft": True, "passed": True},
        {"validation": "source_contract", "required_for_6ft": True, "passed": True},
        {"validation": "downstream_contract", "required_for_6ft": True, "passed": True},
        {"validation": "artifact_contract", "required_for_6ft": True, "passed": True},
        {"validation": "runtime_field_contract", "required_for_6ft": True, "passed": True},
        {"validation": "status_contract", "required_for_6ft": True, "passed": True},
        {"validation": "safety_contract", "required_for_6ft": True, "passed": True},
        {"validation": "determinism_contract", "required_for_6ft": True, "passed": True},
        {"validation": "immutability_contract", "required_for_6ft": True, "passed": True},
    ]
    ...
    recommended_path_rows = [
        ...
        {"decision": "implementation_target", "expected": "downstream-facing artifact surfaces", "actual": "downstream-facing artifact surfaces", "passed": True},
        {"decision": "implementation_scope", "expected": "consume existing usage-facing artifact only", "actual": "consume existing usage-facing artifact only", "passed": True},
    ]
    ...
    csv_counts = {
        ...
        "downstream_contract": write_csv(PLAN_DOWNSTREAM_CONTRACT_CSV, downstream_rows),
    ...
    summary = {
        ...
        "recommended_implementation_target": "downstream-facing artifact surfaces",
        "approved_downstream_source": APPROVED_DOWNSTREAM_SOURCE,
        "approved_usage_source": APPROVED_USAGE_SOURCE,
        "future_downstream_helper": FUTURE_DOWNSTREAM_HELPER,
        ...
        "validator_6fq_returncode": validator_run.returncode,
        "audit_6fr_returncode": audit_run.returncode,
        ...
        "artifact_paths": {
            ...
            "downstream_contract_csv": str(PLAN_DOWNSTREAM_CONTRACT_CSV),
