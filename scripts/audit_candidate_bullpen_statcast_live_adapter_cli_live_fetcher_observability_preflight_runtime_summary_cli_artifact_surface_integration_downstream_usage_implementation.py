#!/usr/bin/env python3
"""Audit 6EY downstream usage of the CLI diagnostic artifact surface."""
...
IMPL_ARTIFACTS = {
    ...
    "downstream_usage_contract": TMP_DIR / f"{IMPL_SLUG}_downstream_usage_contract.csv",
...
EXPECTED_IMPL_COUNTS = {
    "checks": 10,
    "source_contract": 15,
    "downstream_usage_contract": 7,
    "artifact_contract": 7,
    "runtime_field_contract": 10,
    "status_contract": 7,
    "safety_contract": 28,
    "determinism": 2,
    "module_self_check": 13,
    "immutability": 9,
}
...
AUDIT_DOWNSTREAM_USAGE_CONTRACT_CSV = TMP_DIR / f"{AUDIT_SLUG}_downstream_usage_contract.csv"
...
RECOMMENDED_NEXT_LAYER = (
    "6FA_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_"
    "preflight_runtime_summary_cli_artifact_surface_integration_downstream_usage_reporting_plan"
)
RECOMMENDED_PATH = "audit_downstream_runtime_summary_usage_artifact_consumption"
...
DOWNSTREAM_WRAPPER = "_candidate_bullpen_emit_module_self_check_summary_with_downstream_usage"
...
def load_module() -> Any:
    module_name = "candidate_bullpen_live_adapter_6ez_audit"
...
def main() -> int:
    ...
    helper_source = inspect.getsource(downstream_helper) if downstream_helper is not None else ""
    ...
    source_rows = [
        ...
        {"check": "downstream_wrapper_present", "expected": DOWNSTREAM_WRAPPER, "actual": DOWNSTREAM_WRAPPER if DOWNSTREAM_WRAPPER in target_source else "missing", "passed": DOWNSTREAM_WRAPPER in target_source},
        {"check": "downstream_self_check_field_present", "expected": "downstream_runtime_summary_usage_artifact_created", "actual": "downstream_runtime_summary_usage_artifact_created" if "downstream_runtime_summary_usage_artifact_created" in target_source else "missing", "passed": "downstream_runtime_summary_usage_artifact_created" in target_source},
    ...
    artifact = downstream_helper() if downstream_helper is not None else {}
    ...
    immutability_rows = [
        {"surface": "audit_only", "policy": "only_new_6ez_audit_script_added", "passed": True},
    ...
    recommended_path_rows = [
        ...
        {"decision": "audited_implementation_layer", "expected": "6EY", "actual": "6EY", "passed": True},
        ...
        {"decision": "reason", "expected": "reporting plan after downstream usage implementation audit", "actual": "reporting plan after downstream usage implementation audit", "passed": True},
    ]
    ...
    csv_counts = {
        ...
        "downstream_usage_contract": write_csv(AUDIT_DOWNSTREAM_USAGE_CONTRACT_CSV, downstream_usage_rows),
    ...
    summary = {
        ...
        "artifact_paths": {
            ...
            "downstream_usage_contract_csv": str(AUDIT_DOWNSTREAM_USAGE_CONTRACT_CSV),
