...
AUDIT_VERSION = "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit_v0.1"
...
PLAN_JSON = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan.json"
PLAN_CHECKS = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_checks.csv"
PLAN_CURRENT = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_current_state.csv"
PLAN_GATES = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_gates.csv"
PLAN_ACCEPTANCE = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_acceptance_contract.csv"
PLAN_NON_GOALS = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_non_goals.csv"
PLAN_FUTURE_VALIDATION = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_future_validation.csv"
PLAN_IMMUTABILITY = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_immutability.csv"

OUTPUT_JSON = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit.json"
OUTPUT_CHECKS = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit_checks.csv"
OUTPUT_PLAN_EXECUTION = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit_execution.csv"
OUTPUT_PLAN_ARTIFACTS = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit_artifacts.csv"
OUTPUT_CURRENT = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit_current_state.csv"
OUTPUT_GATES = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit_gates.csv"
OUTPUT_ACCEPTANCE = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit_acceptance_contract.csv"
OUTPUT_NON_GOALS = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit_non_goals.csv"
OUTPUT_FUTURE_VALIDATION = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit_future_validation.csv"
OUTPUT_IMMUTABILITY = OUTPUT_DIR / "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit_immutability.csv"
...
def _run_plan() -> Dict[str, Any]:
    ...
    flags = [
        "current_state_valid",
        "preflight_readiness_gates_defined",
        "preflight_acceptance_contract_defined",
    ...
    return {
        ...
        "passed": (
            ...
            and diagnosis.get("diagnosis") == "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_complete"
...
def _gate_rows() -> List[Dict[str, Any]]:
    ...
    return [
        {"check": "dry_run_required_defined", "passed": _contains(rows, "dry_run_required", "dry-run"), "detail": True},
        {"check": "single_date_window_required_defined", "passed": _contains(rows, "single_date_window_required", "exactly one label date"), "detail": True},
        {"check": "write_flags_blocked_defined", "passed": _contains(rows, "write_flags_blocked", "blocked"), "detail": True},
        {"check": "real_fetcher_explicit_env_gate_defined", "passed": _contains(rows, "real_fetcher_explicit_env_gate", "env-gated"), "detail": True},
        {"check": "synthetic_validation_only_defined", "passed": _contains(rows, "synthetic_test_double_validation_only", "validation-only"), "detail": True},
        {"check": "dependency_missing_safe_defined", "passed": _contains(rows, "dependency_missing_safe", "safe"), "detail": True},
        {"check": "ci_network_fetch_prohibited_defined", "passed": _contains(rows, "ci_network_fetch_prohibited", "must not perform network fetches"), "detail": True},
        {"check": "preflight_non_authoritative_for_writes_defined", "passed": _contains(rows, "preflight_non_authoritative_for_writes", "non-authoritative for writes"), "detail": True},
    ]
...
def _acceptance_rows() -> List[Dict[str, Any]]:
    ...
    return [
        {"check": "default_live_dry_run_ready", "passed": _contains(rows, "default_live_dry_run", "live_preflight_ready"), "detail": True},
        {"check": "synthetic_live_dry_run_ready", "passed": _contains(rows, "synthetic_live_dry_run", "synthetic gate true"), "detail": True},
        {"check": "monkeypatched_real_gated_ready_without_network", "passed": _contains(rows, "monkeypatched_real_gated", "without network"), "detail": True},
        {"check": "live_without_dry_run_requires_dry_run", "passed": _contains(rows, "live_without_dry_run", "live_requires_dry_run"), "detail": True},
        {"check": "live_write_attempt_blocked", "passed": _contains(rows, "live_write_attempt", "live_write_blocked"), "detail": True},
        {"check": "invalid_multi_date_invalid", "passed": _contains(rows, "invalid_or_multi_date", "live_date_window_invalid"), "detail": True},
        {"check": "artifact_field_contract_defined", "passed": _contains(rows, "artifact_field_contract", "existing 15 fields", "8 observability fields", "10 preflight fields"), "detail": True},
    ]
...
def _future_validation_rows() -> List[Dict[str, Any]]:
    ...
    expected = [
        ...
        "source_audit",
        "preflight_helper_audit",
        "default_live_dry_run_artifact_audit",
        "synthetic_artifact_audit",
        "monkeypatched_real_gated_artifact_audit",
        "blocked_path_artifact_audit",
...
def main() -> None:
    ...
    checks = [
        ...
        {"check": "preflight_readiness_gates_valid", "passed": all(row["passed"] for row in gate_rows), "detail": f"{sum(row['passed'] for row in gate_rows)}/{len(gate_rows)}"},
        {"check": "preflight_acceptance_contract_valid", "passed": all(row["passed"] for row in acceptance_rows), "detail": f"{sum(row['passed'] for row in acceptance_rows)}/{len(acceptance_rows)}"},
    ...
    diagnosis = {
        "diagnosis": "candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit_complete",
        ...
        "preflight_readiness_gate_rows": len(gate_rows),
        "preflight_acceptance_rows": len(acceptance_rows),
        ...
        "preflight_readiness_gates_valid": all(row["passed"] for row in gate_rows),
        "preflight_acceptance_contract_valid": all(row["passed"] for row in acceptance_rows),
        ...
        "recommended_next_layer": (
            "6EJ_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_runtime_summary_plan"
            if all_checks_passed
            else "6EI_patch_candidate_bullpen_statcast_live_adapter_cli_live_fetcher_observability_preflight_operational_readiness_plan_audit"
        ),
    }
