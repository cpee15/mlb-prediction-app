...
import { CANONICAL_REPORT_TYPES, buildReportRequest, canonicalBootstrapMessage, defaultFieldsForObject, initialFieldsByObject, normalizeCanonicalPage, reportExecutionFacts, reportFieldsForMode, savedReportExecutionMode, selectableRequestFields } from '../lib/dashboardReportBuilderState.mjs'
...
function MyDashboardReportBuilderContent() {
  ...
  function invalidateGeneratedReports() { setResults({}); setReportOpen(false); setReportResult(null); setGeneratedAt(null); setError('') }
