...
function displayKey(key) {
  ...
  const map = {
    ...
    environment_calibration_version: 'Calibration Version',
    park_weight: 'Park Weight',
...
function GameSimulationPanel({ simulation, homeName, awayName }) {
  ...
  const summaryRows = [
    ...
    ['Raw Total Expected Runs', simulation.raw_total_expected_runs],
    [`Raw ${awayName} Expected Runs`, simulation.raw_away_expected_runs],
    [`Raw ${homeName} Expected Runs`, simulation.raw_home_expected_runs],
